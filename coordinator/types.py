...
class PowerReadings:
    ...
    # 0 when this cycle's read was accepted (and 0 before any read — there
    # is nothing to age). The twin flag above is boolean and cannot tell a
    ...
    # go only past SENSOR_DARK_READ_GRACE_S. Action-type gates (the #932
    # sell) keep reading the flag: acting blind is the danger there.
    battery_soc_stale_s: int = 0
