...
ROSTER: Final[Dict[str, Dict[str, Any]]] = {
    ...
    'apsystems': {'name': 'APsystems', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 1287, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'aurora_abb_powerone': {'name': 'Aurora ABB PowerOne Solar PV', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 51, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    'battery_smartflow_ai': {'name': 'Battery SmartFlow AI', 'repo': 'PalmManiac/battery-smartflow-ai', 'origin': 'hacs', 'installs': 72, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    'blue_current': {'name': 'Blue Current', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 40, 'kind': 'charger', 'kind_from': 'vocabulary_name_only'},
    'bluetti_bt': {'name': 'Bluetti BT', 'repo': 'Patrick762/hassio-bluetti-bt', 'origin': 'hacs', 'installs': 478, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'easee': {'name': 'Easee EV Charger', 'repo': 'nordicopen/easee_hass', 'origin': 'hacs', 'installs': 3533, 'kind': 'charger', 'kind_from': 'vocabulary_name_only'},
    ...
    'ef_ble': {'name': 'EcoFlow BLE', 'repo': 'rabits/ha-ef-ble', 'origin': 'hacs', 'installs': 1197, 'kind': 'energy', 'kind_from': 'vocabulary'},
    ...
    'elgato': {'name': 'Elgato', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 3753, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'enphase_envoy': {'name': 'Enphase Envoy', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 10259, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'evcc_intg': {'name': 'evcc☀️🚘- Solar Charging', 'repo': 'marq24/ha-evcc', 'origin': 'hacs', 'installs': 4277, 'kind': 'charger', 'kind_from': 'vocabulary'},
    'evcnet': {'name': 'EVC-net (Last Mile Solutions)', 'repo': 'Platzii/homeassistant-evcnet', 'origin': 'hacs', 'installs': 89, 'kind': 'charger', 'kind_from': 'vocabulary_name_only'},
    ...
    'fujitsu_fglair': {'name': 'FGLair', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 222, 'kind': 'other', 'kind_from': 'keyword'},
    ...
    'garo_wallbox': {'name': 'Garo Wallbox', 'repo': 'sockless-coding/garo_wallbox', 'origin': 'hacs', 'installs': 104, 'kind': 'charger', 'kind_from': 'vocabulary_name_only'},
    ...
    'heidelberg_energy_control': {'name': 'Heidelberg Energy Control', 'repo': 'Schrolli91/heidelberg_energy_control', 'origin': 'hacs', 'installs': 26, 'kind': 'charger', 'kind_from': 'vocabulary_name_only'},
    'homematicip_local': {'name': 'Homematic(IP) Local for OpenCCU', 'repo': 'SukramJ/homematicip_local', 'origin': 'hacs', 'installs': 10036, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    'homewizard': {'name': 'HomeWizard', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 18805, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'lambda_heat_pumps': {'name': 'Lambda Heat Pumps', 'repo': 'GuidoJeuken-6512/lambda_heat_pumps', 'origin': 'hacs', 'installs': 262, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'luxtronik2': {'name': 'Luxtronik', 'repo': 'BenPru/luxtronik', 'origin': 'hacs', 'installs': 583, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'mitsubishi_comfort': {'name': 'Mitsubishi Comfort', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 107, 'kind': 'energy', 'kind_from': 'keyword'},
    ...
    'mypv': {'name': 'MyPV', 'repo': 'dneprojects/mypv', 'origin': 'hacs', 'installs': 544, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'omnik_inverter': {'name': 'Omnik Inverter Solar Sensor (No Cloud)', 'repo': 'robbinjanssen/home-assistant-omnik-inverter', 'origin': 'hacs', 'installs': 333, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'pirateweather': {'name': 'Pirate Weather', 'repo': 'Pirate-Weather/pirate-weather-ha', 'origin': 'hacs', 'installs': 8327, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'powerwall': {'name': 'Tesla Powerwall', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 1994, 'kind': 'energy', 'kind_from': 'vocabulary'},
    ...
    'renogy': {'name': 'Renogy', 'repo': 'IAmTheMitchell/renogy-ha', 'origin': 'hacs', 'installs': 148, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'silla_prism': {'name': 'Silla Prism Solar wallbox integration', 'repo': 'persuader72/silla-prism-integration', 'origin': 'hacs', 'installs': 76, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'sma_ennexos': {'name': 'SMA ennexOS', 'repo': 'shadow578/homeassistant_sma-ennexos', 'origin': 'hacs', 'installs': 69, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    'smaev': {'name': 'SMA EV Charger', 'repo': 'alengwenus/ha-sma-ev-charger', 'origin': 'hacs', 'installs': 348, 'kind': 'charger', 'kind_from': 'vocabulary'},
    'smappee': {'name': 'Smappee', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 510, 'kind': 'energy', 'kind_from': 'vocabulary'},
    ...
    'solarlog': {'name': 'Solar-Log', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 426, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'solax_cloud_api': {'name': 'Solax Cloud API for Single and Multi Inverter Systems', 'repo': 'NoUsername10/Solax-Cloud-API-for-Home-assistant', 'origin': 'hacs', 'installs': 259, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'subaru': {'name': 'Subaru', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 547, 'kind': 'vehicle', 'kind_from': 'vocabulary'},
    ...
    'tado_ce': {'name': 'Tado CE', 'repo': 'hiall-fyi/tado_ce', 'origin': 'hacs', 'installs': 753, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    'tesla_fleet': {'name': 'Tesla Fleet', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 4604, 'kind': 'energy', 'kind_from': 'vocabulary'},
    'tesla_wall_connector': {'name': 'Tesla Wall Connector', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 6555, 'kind': 'charger', 'kind_from': 'vocabulary_name_only'},
    'teslemetry': {'name': 'Teslemetry', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 1042, 'kind': 'energy', 'kind_from': 'vocabulary'},
    'tessie': {'name': 'Tessie', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 1814, 'kind': 'energy', 'kind_from': 'vocabulary'},
    ...
    'tibber_prices': {'name': 'Tibber Price Information & Ratings', 'repo': 'jpawlowski/hass.tibber_prices', 'origin': 'hacs', 'installs': 955, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    ...
    'vicare': {'name': 'Viessmann ViCare', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 5930, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
    'victron': {'name': 'Victron GX modbus TCP', 'repo': 'sfstar/hass-victron', 'origin': 'hacs', 'installs': 1987, 'kind': 'energy', 'kind_from': 'keyword'},
    'victron_ble': {'name': 'Victron BLE', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 1945, 'kind': 'energy', 'kind_from': 'vocabulary'},
    'victron_gx': {'name': 'Victron GX', 'repo': 'home-assistant/core', 'origin': 'core', 'installs': 2754, 'kind': 'energy', 'kind_from': 'vocabulary'},
    'victron_mk3': {'name': 'Victron MK3', 'repo': 'j9brown/victron-mk3-hass', 'origin': 'hacs', 'installs': 20, 'kind': 'energy', 'kind_from': 'vocabulary'},
    'victron_mqtt': {'name': 'Victron MQTT Integration', 'repo': 'tomer-w/ha-victron-mqtt', 'origin': 'hacs', 'installs': 1634, 'kind': 'energy', 'kind_from': 'vocabulary'},
    ...
    'waterkotte_heatpump': {'name': 'Waterkotte Heatpump [+2020]', 'repo': 'marq24/ha-waterkotte', 'origin': 'hacs', 'installs': 118, 'kind': 'energy', 'kind_from': 'vocabulary_name_only'},
...
ROLE_VOCAB: Final[Dict[str, Dict[str, Dict[str, Any]]]] = {
    ...
    'tesla_fleet': {
        ...
        'grid_power': {'platform': 'sensor', 'keys': ('grid_power',), 'options': ()},
        'solar_power': {'platform': 'sensor', 'keys': ('solar_power',), 'options': ()},
        'vehicle_range': {'platform': 'sensor', 'keys': ('charge_state_battery_range', 'charge_state_est_battery_range', 'charge_state_ideal_battery_range'), 'options': ()},
    },
    'teslemetry': {
        'battery_power': {'platform': 'sensor', 'keys': ('battery_power',), 'options': ()},
        'grid_power': {'platform': 'sensor', 'keys': ('grid_power',), 'options': ()},
        'solar_power': {'platform': 'sensor', 'keys': ('solar_power',), 'options': ()},
        'vehicle_range': {'platform': 'sensor', 'keys': ('charge_state_battery_range', 'charge_state_est_battery_range', 'charge_state_ideal_battery_range', 'rated_range'), 'options': ()},
    },
    'tessie': {
        'battery_power': {'platform': 'sensor', 'keys': ('battery_power',), 'options': ()},
        'grid_power': {'platform': 'sensor', 'keys': ('grid_power',), 'options': ()},
