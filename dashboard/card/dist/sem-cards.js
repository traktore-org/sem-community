        ...
        <div class="device${s?" is-child":""}" data-id="${e.id}" style="${a}">
            ...
            <div class="device-body">
                ...
                <div class="device-bottom">
                    ...
                    <span class="mode-chip" title="${this._t("mode_tooltip")}">${this._mergedModeLabel(e)}</span>`}
            ...
            </div>`}_renderGoalEditor(e){const t=e.goals||{},i=this._mergedMode(e),s=("surplus_cheap"===i||"surplus_deadline"===i)&&!this._hasTarget(e);return W`
            <div class="goal-editor">
                ...
                <div class="ge-row">
                    ...
                    <span class="ge-ctl">
                        <select class="ge-mode-select" data-action="combined_mode" data-device="${e.id}">
                            <option value="off" ?selected="${"off"===i}">${this._t("off")}</option>
                            <option value="peak_only" ?selected="${"peak_only"===i}">${this._t("peak_only")}</option>
                            <option value="surplus_solar" ?selected="${"surplus_solar"===i}">${this._t("mode_surplus_solar")}</option>
                            <option value="surplus_cheap" ?selected="${"surplus_cheap"===i}">${this._t("mode_surplus_cheap")}</option>
                            <option value="surplus_deadline" ?selected="${"surplus_deadline"===i}">${this._t("mode_surplus_deadline")}</option>
                        </select>
                    </span>
                </div>
                ${s?W`
                ...
                <div class="ge-row">
                    ...
                    <span class="ge-ctl">
                        <input type="number" min="0" max="1440" step="5"
                               .value="${String(t.daily_min_runtime_min||0)}"
                               data-goal="daily_min_runtime_min" data-device="${e.id}">
                ...
                <div class="ge-row">
                    ...
                    <span class="ge-ctl">
                        <input type="number" min="0" max="1440" step="5"
                               .value="${String(t.daily_max_runtime_min||0)}"
                               data-goal="daily_max_runtime_min" data-device="${e.id}">
                        <span class="ge-unit">min</span>
                    </span>
                </div>
                <div class="ge-row">
                    ...
                    <span class="ge-ctl">
                        <input type="number" min="0" max="200" step="0.5"
                               .value="${String(t.daily_target_energy_kwh||0)}"
                               data-goal="daily_target_energy_kwh" data-device="${e.id}">
