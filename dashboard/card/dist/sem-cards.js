            ...
            <ha-card>
                <div class="wrap">
                    ...
                    <div class="strip ${c?"":"nostrip"}">
                        ...
                        ${r.map(e=>{const t=yt[e.kind]||yt.load,i=vt[e.status]||vt.yields,s=$[e.id]||[],r=e.label||this._t(t.label),a="fits"===e.status?`${(e.planned_kwh||0).toFixed(1)} kWh`:`${(e.planned_kwh||0).toFixed(1)}/${(e.needed_kwh||0).toFixed(1)} kWh`;return W`
                                <div class="lbl">
                                ...
                                ${c?W`
                                    <div class="track">
                                        ${p}
                                        ${s.map(e=>{const i=(Date.parse(e.start)-n)/l*100,s=(Date.parse(e.end)-Date.parse(e.start))/l*100;return W`
                                                <div class="seg run"
