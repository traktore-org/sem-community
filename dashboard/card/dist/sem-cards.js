...
`;class Se extends ce{constructor(){super(),this._hass=null,this._config=null,this._lang=null,this._localizeReady=!1,this._prevVals={},this._frozenEntities={},this._holdTimers={},this._holdIntervals={},this._cachedTheme=null,this._updateTimer=null}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;const r=this.constructor.watchedEntities||[];if(r.length>0&&!s){const t=e.states[r[0]]?.state;if("unavailable"===t||"unknown"===t)return}let a=!1;for(const t of r){const i=e.states[t]?.state;if(this._prevVals[t]!==i){a=!0;break}}if(a||s){for(const t of r)this._prevVals[t]=e.states[t]?.state;this._scheduleUpdate()}}get hass(){return this._hass}_scheduleUpdate(){this._updateTimer||(this._updateTimer=setTimeout(()=>{this._updateTimer=null,this.requestUpdate()},16))}_theme(){const e=getComputedStyle(document.documentElement).getPropertyValue("--primary-background-color").trim();return this._cachedTheme&&this._cachedThemeKey===e||(this._cachedThemeKey=e,this._cachedTheme=ye()),this._cachedTheme}_t(e){return e?"function"==typeof semLocalize?semLocalize(e,this._hass?.language):e:""}_forecastProviderLabel(e){if(!e)return"";return{solcast:"Solcast",forecast_solar:"Forecast.Solar",open_meteo:"Open-Meteo",custom:this._t("custom")||"Custom"}[e]||e}_state(e,t=0){const i=this._frozenEntities[e];if(i)return i.value;const s=this._hass?.states[e];return s&&"unavailable"!==s.state&&"unknown"!==s.state?parseFloat(s.state)??t:t}_stateStr(e){const t=this._frozenEntities[e];if(t)return String(t.value);const i=this._hass?.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:""}_unitOf(e){const t=this._hass?.states[e];return t&&t.attributes&&t.attributes.unit_of_measurement||""}_pcEntity(e,t,i){const s=this._hass?.states||{},r=new RegExp(`^${e}\\.sem_charger_.+_${t}$`);let a=Object.keys(s).filter(e=>r.test(e));return"night_charging"===t&&(a=a.filter(e=>!e.endsWith("_smart_night_charging"))),a.sort(),a.length?a[0]:i}_stateAttrs(e){return this._hass?.states[e]?.attributes||{}}_freezeEntity(e,t){const i=this._frozenEntities[e];i?.timer&&clearTimeout(i.timer),this._frozenEntities[e]={value:t,timer:setTimeout(()=>{delete this._frozenEntities[e],this.requestUpdate()},1500)}}_isFrozen(){return Object.keys(this._frozenEntities).length>0}async _callService(e,t,i){if(this._hass)try{await this._hass.callService(e,t,i)}catch(e){console.error(`[SEM ${this.tagName}]`,e)}}_setNumber(e,t){const i=this._hass?.states[e];if(!i)return;const s=parseFloat(i.attributes.min)||0,r=parseFloat(i.attributes.max)||100,a=Math.max(s,Math.min(r,t));this._freezeEntity(e,a),this.requestUpdate(),this._callService("number","set_value",{entity_id:e,value:a})}_stepNumber(e,t){const i=this._hass?.states[e];if(!i)return;const s=this._frozenEntities[e],r=s?s.value:parseFloat(i.state)||0,a=parseFloat(i.attributes.step)||1;this._setNumber(e,r+t*a)}_toggleSwitch(e){const t=this._hass?.states[e];if(!t)return;const i="on"===t.state?"off":"on";this._freezeEntity(e,i),this.requestUpdate();const s="on"===t.state?"turn_off":"turn_on";this._callService("switch",s,{entity_id:e})}_selectOption(e,t){this._freezeEntity(e,t),this.requestUpdate(),this._callService("select","select_option",{entity_id:e,option:t})}_startHold(e,t){this._stopHold(e),this._holdTimers[e]=setTimeout(()=>{this._holdIntervals[e]=setInterval(()=>{this._stepNumber(e,t)},150)},400)}_stopHold(e){clearTimeout(this._holdTimers[e]),clearInterval(this._holdIntervals[e]),delete this._holdTimers[e],delete this._holdIntervals[e]}updated(){if(window._semDebug){this.style.outline="2px solid red",this.style.outlineOffset="-2px",clearTimeout(this._debugFlashTimer),this._debugFlashTimer=setTimeout(()=>{this.style.outline="",this.style.outlineOffset=""},200);const e=this.tagName.toLowerCase();window._semRenderLog||(window._semRenderLog={}),window._semRenderLog[e]=(window._semRenderLog[e]||0)+1}}connectedCallback(){super.connectedCallback(),window._semDebug&&console.log(`[SEM DEBUG] ${this.tagName} connectedCallback`),this._localizeReady||"function"==typeof semLocalize?"function"==typeof semLocalize&&(this._localizeReady=!0):(this._onLocalizeReady=()=>{document.removeEventListener("sem-localize-ready",this._onLocalizeReady),this._onLocalizeReady=null,this._localizeReady=!0,this._hass&&this.requestUpdate()},document.addEventListener("sem-localize-ready",this._onLocalizeReady))}disconnectedCallback(){super.disconnectedCallback(),window._semDebug&&console.log(`[SEM DEBUG] ${this.tagName} disconnectedCallback !!!`),this._onLocalizeReady&&(document.removeEventListener("sem-localize-ready",this._onLocalizeReady),this._onLocalizeReady=null),this._updateTimer&&(clearTimeout(this._updateTimer),this._updateTimer=null);for(const e of Object.keys(this._holdTimers))this._stopHold(e);for(const e of Object.keys(this._frozenEntities))clearTimeout(this._frozenEntities[e]?.timer);this._frozenEntities={}}setConfig(e){this._config=e}getCardSize(){return 4}static getStubConfig(){return{}}}we("sem-title-card",class extends Se{static get watchedEntities(){return[]}constructor(){super(),this._renderedSubtitle=null,this._templateUnsub=null,this._templateSubbed=!1}setConfig(e){super.setConfig(e),this._unsubTemplate(),this._templateSubbed=!1,this._renderedSubtitle=null}_hasJinja(e){return e&&(e.includes("{%")||e.includes("{{"))}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;(t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,this.requestUpdate()),this._hasJinja(this._config?.subtitle)&&!this._templateSubbed&&this._subscribeTemplate()}_subscribeTemplate(){if(!this._hass?.connection||this._templateSubbed)return;this._templateSubbed=!0;const e=this._config.subtitle;this._hass.connection.subscribeMessage(e=>{const t=e.result;t!==this._renderedSubtitle&&(this._renderedSubtitle=t,this.requestUpdate())},{type:"render_template",template:e,variables:{}}).then(e=>{this._templateUnsub=e}).catch(()=>{this._renderedSubtitle=this._config.subtitle,this.requestUpdate()})}_unsubTemplate(){this._templateUnsub&&(this._templateUnsub(),this._templateUnsub=null)}disconnectedCallback(){super.disconnectedCallback(),this._unsubTemplate()}render(){if(!this._config)return q;const e=this._t(this._config.title_key||this._config.title||"");let t="";t=this._hasJinja(this._config.subtitle)?this._renderedSubtitle||"":this._t(this._config.subtitle||"");const i=this._theme();return W`
    ...
    `;getCardSize(){return this._inner?.getCardSize?.()||3}}we("sem-require",Ce,{type:"custom:sem-require",name:"SEM Require Wrapper",description:"Renders a card only when its HACS dependency is installed; otherwise a friendly install notice",preview:!1});const ze=(e,t)=>"function"==typeof semLocalize?semLocalize(e,t?.language):e,Me={home:{titleKey:"home",subtitleKey:"home_sub",color:"#5BC8D8",icon:()=>j`
        ...
        `}getCardSize(){return 3}static getStubConfig(){return{entity_prefix:Fe}}},{type:"custom:sem-energy-impact-card",name:"SEM Energy Impact Card",description:"Environmental impact display for Solar Energy Management",preview:!1});const Ne="daily_ev_energy",Pe="lifetime_ev_energy",Ae="lifetime_ev_solar_share",Te="lifetime_ev_cost",Le="lifetime_ev_sessions",Re="sensor.sem_";we("sem-ev-progress-card",class extends Se{static get watchedEntities(){return[`${Re}${Ne}`,`${Re}${Pe}`,`${Re}${Ae}`,`${Re}${Te}`,`${Re}${Le}`,"number.sem_daily_ev_target","number.sem_charger_ev_charger_daily_ev_target"]}_evDailyTarget(){const e=this._hass?.states||{},t=Object.keys(e).filter(e=>/^number\.sem_charger_.+_daily_ev_target$/.test(e)).sort();if(t.length){const i=parseFloat(e[t[0]]?.state);if(!isNaN(i))return i}return this._state("number.sem_daily_ev_target",10)}setConfig(e){super.setConfig(e)}_prefix(){return this._config?.entity_prefix??Re}_pct(e,t){return t<=0?0:Math.min(100,e/t*100)}_barColor(e,t){return 0===e?"#666":t>=100?"#8DC892":t>=70?"#ff9800":"#f44336"}_fmtEnergy(e){return null==e||isNaN(e)?"—":e.toFixed(e<10?2:1)+" kWh"}_fmtCost(e,t){return null==e||isNaN(e)?"—":e.toFixed(2)+" "+t}_fmtSessions(e){return null==e||isNaN(e)?"—":String(Math.round(e))}render(){if(!this._hass||!this._config)return q;const e=this._theme(),t=this._prefix(),i=this._state(`${t}${Ne}`),s=this._evDailyTarget(),r=this._state(`${t}${Pe}`),a=this._state(`${t}${Ae}`),o=this._state(`${t}${Te}`),n=this._state(`${t}${Le}`),l=me(this._hass),c=this._pct(i,s),d=this._barColor(s,c),p=s>0?W`<span class="target-pct">${Math.round(c)}% ${this._t("of_target")}</span>`:W`<span class="target-pct no-target">${this._t("no_target")}</span>`,h=["radial-gradient(ellipse 80% 70% at 20% 50%, rgba(141,200,146,0.06) 0%, transparent 70%)",`radial-gradient(circle at 2px 2px, ${e.dotColor} 0.7px, transparent 0.7px)`].join(", ");return W`
            <style>
                :host {
                    display: block;
                    font-family: 'Segoe UI', 'Roboto', sans-serif;
        ...
        `}render(){if(!this._hass||!this._config)return q;const e=this._theme(),t=2*Math.PI*42,i=t.toFixed(1),s=this._val("battery_soc",0),r=this._val("battery_power",0),a=this._val("battery_charge_power",0),o=this._val("battery_discharge_power",0),n=(this._valStr("battery_status")||"").toLowerCase(),l=this._val("battery_health_score",0),c=this._val("battery_cycles_estimated",0),d=this._val("daily_battery_charge_energy",0),p=this._val("daily_battery_discharge_energy",0),h=this._val("daily_battery_savings",0),_=this._val("monthly_battery_charge_energy",0),g=this._val("monthly_battery_discharge_energy",0),u=this._val("flow_solar_to_battery_energy",0),f=me(this._hass),m=this._hass?.states[`${this._prefix}battery_temperature`],y=m&&"unavailable"!==m.state&&"unknown"!==m.state?parseFloat(m.state):null,v=(x=m)&&x.attributes&&x.attributes.unit_of_measurement||"°C";var x;const b="selling"===n,$=!b&&("charging"===n||a>10),w=!b&&("discharging"===n||o>10),k=this._hass?.states["sensor.sem_tariff_current_export_rate"],S=k&&"unavailable"!==k.state&&"unknown"!==k.state?parseFloat(k.state):null,C="#FCD170",z=b?this._t("selling_to_grid"):$?this._t("charging"):w?this._t("discharging"):this._t("idle"),M=b?C:$?"#f06292":"#4db6ac",E=b?C:$?"#f06292":w?"#4db6ac":e.textSec||"#888",D=$||w||b?"0.5":"0.2",F=$||w||b?"socPulse 2s ease-in-out infinite":"none",I=Math.min(Math.max(s/100,0),1),B=(t*(1-I)).toFixed(1),N=d>0?Math.round(u/d*100):0,P=this._valStr("battery_session_type"),A="charge"===P||"discharge"===P,T="charge"===P,L=A?this._val("battery_session_energy",0):0,R=A?this._val("battery_session_duration",0):0,O=A?this._val("battery_session_avg_power",0):0,U=A?this._val("battery_session_solar_share",0):0,H=A?this._val("battery_session_cost",0):0,j=A?this._val("battery_session_savings",0):0,G=T?"#f06292":"#4db6ac";e.dotColor;const K=e.surface||"rgba(255,255,255,0.06)",V=e.surfaceBorder||"rgba(255,255,255,0.05)",Y=e.surfaceHover||"rgba(255,255,255,0.12)",X=e.textSec||"#999",Z=e.textTertiary||"#888";return W`
            <style>
                    ...
                    <div class="hero">
                        <div class="battery-ring">
                            <svg viewBox="0 0 100 100">
                                <circle class="glow-ring" cx="50" cy="50" r="42"
                                    style="stroke:${M};opacity:${D}"/>
                                <circle class="ring-bg" cx="50" cy="50" r="42"/>
                                <circle class="soc-arc" cx="50" cy="50" r="42"
                                    stroke-dasharray="${i}"
                                    style="stroke-dashoffset:${B};stroke:${M};animation:${F}"/>
                            </svg>
                            <div class="ring-center">
                        ...
                        <div class="metrics-col">
                            ...
                            <div class="metric-row">
                                ...
                                <span class="metric-val" style="color:${C}">${this._fmt(S,3)} ${f}/kWh</span>
                            </div>
                            `:q}
                            <div class="metric-row">
                    ...
                    <div class="session-section">
                        <div class="sess-header">
                            <ha-icon icon="mdi:battery-sync"
                                style="--mdc-icon-size:14px;color:${A?G:e.textSec}">
                            </ha-icon>
                            <span class="sess-title" style="color:${A?G:e.textSec}">
                        ...
                        <div class="sess-grid">
                            ...
                            <div>
                                ...
                                <div class="sess-item-value">
                                    ${T?`${this._t("solar")}: ${this._fmt(U,0)}%`:""}
                                </div>
                            </div>
                            <div>
                                <div class="sess-item-label">${this._t("cost")}</div>
                                <div class="sess-item-value">
                                    ${T?`${this._fmt(H,2)} ${f}`:`${this._t("saved")} ${this._fmt(j,2)} ${f}`}
                                </div>
                            </div>
                        </div>
                        `:W``}
        ...
        `}getCardSize(){return 8}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-system-card",name:"SEM System Card",description:"Consolidated system panel for Solar Energy Management",preview:!1});const mt={now:{icon:"mdi:clock-outline",color:"#5BC8D8"},solar_peak:{icon:"mdi:weather-sunny",color:"#ff9800"},solar_end:{icon:"mdi:weather-sunset",color:"#ff9800"},cheap_start:{icon:"mdi:arrow-down-bold",color:"#8DC892"},cheap_end:{icon:"mdi:arrow-up-bold",color:"#ff9800"},expensive_start:{icon:"mdi:flash-alert",color:"#f06292"},expensive_end:{icon:"mdi:flash-off",color:"#8DC892"},night_open:{icon:"mdi:weather-night",color:"#8353d1"},night_end:{icon:"mdi:weather-sunset-up",color:"#ff9800"},ev_charge_start:{icon:"mdi:ev-station",color:"#8DC892"},ev_min_reached:{icon:"mdi:battery-charging-80",color:"#4db6ac"},ev_target_reached:{icon:"mdi:car-electric",color:"#8DC892"},ev_deadline:{icon:"mdi:clock-end",color:"#f06292"},ev_wait:{icon:"mdi:pause-circle",color:"#8353d1"},battery_full:{icon:"mdi:battery-charging-100",color:"#f06292"},battery_empty:{icon:"mdi:battery-low",color:"#4db6ac"},device_run:{icon:"mdi:power-plug",color:"#5BC8D8"},device_done:{icon:"mdi:check-circle",color:"#8DC892"}};we("sem-today-plan-card",class extends Se{setConfig(e){super.setConfig(e),this._entity=e.entity||"sensor.sem_charging_state"}set hass(e){this._hass=e;const t=(e?.states[this._entity]?.attributes||{}).today_plan||[],i=[t.length,t[0]?.when,t.at(-1)?.when,this._lang].join("|"),s="function"==typeof semLocalize;(i!==this._lastKey||s&&!this._localizeReady)&&(this._lastKey=i,this._lang=e?.language,this._localizeReady=s,this.requestUpdate())}get hass(){return this._hass}_hm(e){if(!e)return"—";try{const t=new Date(e),i=this._hass?.config?.time_zone||void 0,s=ue(e,i),r=e=>e.toLocaleDateString("en-CA",{timeZone:i}),a=r(t),o=new Date;if(a===r(o))return s;if(a===r(new Date(o.getTime()+864e5))){return`${this._t("tomorrow")||"Tomorrow"} ${s}`}return`${t.toLocaleDateString([],{weekday:"short",timeZone:i})} ${s}`}catch(e){return"—"}}_format(e,t){let i=this._t(e);if(!i||i===e)return null;for(const[e,s]of Object.entries(t||{}))i=i.replace(new RegExp(`\\{${e}\\}`,"g"),s);return i}render(){if(!this._hass||!this._config)return q;const e=this._hass.states[this._entity],t=e?.attributes?.today_plan||[];return!Array.isArray(t)||t.length<=1?(this.style.display="none",q):(this.style.display="",W`
            <ha-card>
                <div class="wrap">
                    ...
                    <ul class="rows">
                        ${t.map(e=>{const t=mt[e.kind]||mt.now,i=this._format(e.label,e.values)||e.label,s=e.detail?this._format(e.detail,e.values):null;return W`
        ...
        `}render(){if(!this._hass||!this._config)return q;const e=this._hass.states[this._entity],t=e?.state;if(!e||"unavailable"===t||"unknown"===t)return this.style.display="none",q;this.style.display="";const i=e.attributes||{},s=!0===i.actuation||void 0===i.actuation&&"on"===this._hass.states["switch.sem_overnight_actuation"]?.state;if("pending"===t){const e=this._hass.states["sensor.sem_night_start_time"]?.state,t=e&&/^\d{1,2}:\d{2}$/.test(e)?` (~${e})`:"";return this._renderIdle(s,"overnight_pending",t)}const r=Array.isArray(i.demands)?i.demands:[],a=Array.isArray(i.slots)?i.slots:[],o=Array.isArray(i.blocks)?i.blocks:[];if("idle"===t||!r.length)return this._renderIdle(s);const n=a.length?Date.parse(a[0].start):NaN,l=(a.length?Date.parse(a[a.length-1].end):NaN)-n,c=a.length>0&&Number.isFinite(l)&&l>0,d=this._runs(a,n,l,e=>!!e.cheap).filter(e=>e.v),p=W`
            <div class="band">
                ${d.map(e=>W`
                    <div class="cheap" style="left:${e.left}%;width:${e.width}%"></div>
                `)}
            </div>
        `;let h=a.filter(e=>0===new Date(e.start).getMinutes());h.length||(h=a);const _=Math.max(1,Math.ceil(h.length/8)),g=h.filter((e,t)=>t%_===0).map(e=>({left:(Date.parse(e.start)-n)/l*100,text:this._hm(e.start)})).filter(e=>e.left<=94),u=this._runs(a,n,l,e=>(e.home_grid_w||0)<=1),f=i.takeover?this._format("overnight_takeover",{time:this._hm(i.takeover)}):this._t("overnight_all_night"),m=i.takeover?W`
              ...
              `,y=me(this._hass),v=Number(i.total_cost),x=Number.isFinite(v)?`${this._t("overnight_est")} ${v.toFixed(2)} ${y}`:null,b=!1!==i.fits,$={};for(const e of o)($[e.id]=$[e.id]||[]).push(e);return W`
            <ha-card>
                <div class="wrap">
                    <div class="head">
                        <ha-icon icon="mdi:weather-night" style="--mdc-icon-size:16px;color:#8353d1"></ha-icon>
                    ...
                    <div class="verdict">
                        <ha-icon
                            icon="${b?"mdi:check-circle":"mdi:alert-circle-outline"}"
                            style="--mdc-icon-size:15px;color:${b?"#8DC892":"#f06292"}"></ha-icon>
                        <span class="vtext">
                            ${b?this._t("overnight_fits"):this._t("overnight_yields")}
                        </span>
                        ${x?W`<span class="cost">${x}</span>`:q}
                    </div>

                    <div class="strip ${c?"":"nostrip"}">
                        ${c?W`
                            ...
                            <div class="track axis">
                                ...
                                `)}
                                ${a.map(e=>{const t=(Date.parse(e.start)-n)/l*100,i=(Date.parse(e.end)-Date.parse(e.start))/l*100;if(!Number.isFinite(t)||!Number.isFinite(i))return q;const s=null===e.price||void 0===e.price?"—":`${e.price} ${y}`,r=`${this._hm(e.start)}–${this._hm(e.end)} · ${s}`+(e.cheap?` · ${this._t("overnight_legend_cheap")}`:"");return W`<div class="slotcell" title="${r}"
                        ...
                        `:q}
                        <div class="stat" title="${f}">${m}</div>

                        ${r.map(e=>{const t=yt[e.kind]||yt.load,i=xt[e.status]||xt.yields,r=$[e.id]||[],a=e.label||this._t(t.label),d="fits"===e.status?`${(e.planned_kwh||0).toFixed(1)} kWh`:`${(e.planned_kwh||0).toFixed(1)}/${(e.needed_kwh||0).toFixed(1)} kWh`,h=[a,"comfort"===e.kind?this._t("overnight_comfort_tip"):null,r.map(e=>`${this._hm(e.start)}–${this._hm(e.end)} · ${(e.power_w/1e3).toFixed(1)} kW`).join("\n")||null,`${(e.planned_kwh||0).toFixed(1)} / ${(e.needed_kwh||0).toFixed(1)} kWh · ${this._t("overnight_est")} ${(e.est_cost||0).toFixed(2)} ${y}`,e.note||null].filter(Boolean).join("\n"),_=s?this._liveState(e,o):null,g=e.note||("fits"!==e.status?this._format("overnight_yield_reason",{planned:(e.planned_kwh||0).toFixed(1),needed:(e.needed_kwh||0).toFixed(1)}):null);return W`
                                ...
                                ${c?W`
                                    <div class="track">
                                        ${p}
                                        ${r.map(e=>{const i=(Date.parse(e.start)-n)/l*100,s=(Date.parse(e.end)-Date.parse(e.start))/l*100;return W`
                                                <div class="seg run"
                    ...
                    <div class="foot">${this._t(s?"overnight_active_note":"overnight_shadow_note")}</div>
                </div>
            </ha-card>
        `}static get styles(){return a`
            :host { display: block; }
            ...
            <ha-card>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}"
                    ...
                    ${this._showBattery?j`<g class="flow-group" style="opacity:${Ee?1:0}">
                        ${this._renderFlow(De,Fe,fe(d),e.paths.battery,3)}
                    </g>`:q}
                    <g class="flow-group" style="opacity:${Ie?1:0}">
                        ${this._renderFlow(Be,Ne,fe(n||l),e.paths.grid,3)}
                    </g>
                    <g class="flow-group" style="opacity:${Pe?1:0}">
                        ${this._renderFlow(!1,"#5BC8D8",fe(m),e.paths.home,2)}
                    </g>
                    ${this._showEv?j`<g class="flow-group" style="opacity:${Ae?1:0}">
                    ...
                    <text x="${e.S.cx}" y="${e.S.labelY+1.1*r}" class="clickable"
                          ...
                          font-weight="800" fill="#ff9800">${ve}</text>
                    ...
                    <text x="${e.I.cx}" y="${e.I.cy+e.I.r+14}"
                          text-anchor="middle" font-family="${i}" font-size="${a}"
                          fill="${I}" opacity="${B}" font-weight="600">${ce}</text>
                    <text x="${e.I.cx}" y="${e.I.cy+e.I.r+14+a+2}"
                          text-anchor="middle" font-family="${i}" font-size="${a-1}"
                          fill="${I}" opacity="${N}">${he}</text>
                    ...
                    ${this._showBattery?j`<g filter="url(#glowBattery)" class="clickable"
                       ...
                       @click=${()=>this._showMoreInfo("battery_soc")}>
                        ${this._illustrationBattery(e.B.cx,e.B.cy,e.B.r,R,O,U,H,h)}
                    </g>
        ...
        `)}_collectDevices(){const e=this._eid("controllable_devices_count"),t=e?this._hass?.states[e]:void 0;return t?.attributes?.devices?Object.entries(t.attributes.devices).filter(([,e])=>"ev_charger"!==e.device_type&&"battery"!==e.device_type).map(([e,t])=>{const i=t.power_entity?this._hass.states[t.power_entity]:null,s=i?parseFloat(i.state)||0:t.current_power||0;return{id:e,...t,power:s,name:this._localizedDeviceName(e,t)}}).sort((e,t)=>t.power-e.power).slice(0,3):[]}_localizedDeviceName(e,t){const i={heat_pump:"device_heat_pump",hot_water:"device_hot_water"},s={heat_pump:"Heat Pump",hot_water:"Hot Water"}[e];if(s&&(t.name||"").trim()===s){const t=this._t(i[e]);if(t)return t}return t.name||e}_renderDeviceChips(){const e=this._collectDevices();return e.length?W`
            ...
            <feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge>
                       ...
                       <line x1="-1.5" y1="6" x2="1.5" y2="6"/>`:j`<path d="M-2.5,-9 L-2.5,0 L-5,0 L0,9 L0,0 L2.5,0 L-2.5,-9Z"/>`}getCardSize(){return 7}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-system-diagram-card",name:"SEM System Diagram",description:"Power flow visualization with inline SVG illustrations for each energy component"});const Pt=["/local/custom_components/solar_energy_management/dashboard/card/vendor/chart.umd.min.js","https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js"],At=["/local/custom_components/solar_energy_management/dashboard/card/vendor/chartjs-adapter-date-fns.bundle.min.js","https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3.0.0/dist/chartjs-adapter-date-fns.bundle.min.js"];function Tt(e,t,i){if(!e.length)return void i(new Error("all sources failed"));const s=document.createElement("script");s.src=e[0],s.onload=()=>t(),s.onerror=()=>Tt(e.slice(1),t,i),document.head.appendChild(s)}let Lt=null;const Rt=pe||{solar:"#ff9800",gridImport:"#488fc2",gridExport:"#8353d1",batteryOut:"#4db6ac",home:"#5BC8D8",ev:"#8DC892"},Ot={costs:{title:"energy_costs",y_label:"_currency_",stacked:!1,daily:[{suffix:"daily_costs",name:"Import",color:Rt.gridImport,type:"bar",negate:!0},{suffix:"daily_export_revenue",name:"export",color:Rt.gridExport,type:"bar"},{suffix:"daily_net_cost",name:"net",color:Rt.solar,type:"line",negate:!0}],monthly:[{suffix:"monthly_costs",name:"Import",color:Rt.gridImport,type:"bar",negate:!0},{suffix:"monthly_export_revenue",name:"export",color:Rt.gridExport,type:"bar"},{suffix:"monthly_net_cost",name:"net",color:Rt.solar,type:"line",negate:!0}]},savings:{title:"energy_savings",y_label:"_currency_",stacked:!0,daily:[{suffix:"daily_savings",name:"solar_savings",color:Rt.solar,type:"area"},{suffix:"daily_battery_savings",name:"battery_savings",color:Rt.batteryOut,type:"area"}],monthly:[{suffix:"monthly_savings",name:"solar_savings",color:Rt.solar,type:"area"},{suffix:"monthly_battery_savings",name:"battery_savings",color:Rt.batteryOut,type:"area"}]},energy:{title:"energy_balance",y_label:"kWh",stacked:!1,defaultPeriod:"7d",daily:[{suffix:"daily_solar_energy",name:"solar",color:Rt.solar,type:"bar"},{suffix:"daily_home_energy",name:"home",color:Rt.home,type:"bar"},{suffix:"daily_grid_import_energy",name:"grid_import",color:Rt.gridImport,type:"bar"},{suffix:"daily_grid_export_energy",name:"grid_export",color:Rt.gridExport,type:"bar"}],monthly:[{suffix:"monthly_solar_energy",name:"solar",color:Rt.solar,type:"bar"},{suffix:"monthly_home_energy",name:"home",color:Rt.home,type:"bar"},{suffix:"monthly_grid_import_energy",name:"grid_import",color:Rt.gridImport,type:"bar"},{suffix:"monthly_grid_export_energy",name:"grid_export",color:Rt.gridExport,type:"bar"}]},power:{title:"power_flow",y_label:"W",stacked:!1,hourly:[{suffix:"solar_power",name:"solar",color:Rt.solar,type:"area"},{suffix:"home_consumption_power",name:"home",color:Rt.home,type:"area"},{suffix:"grid_power",name:"grid",color:Rt.gridImport,type:"area"}]},forecast:{title:"forecast_vs_actual",y_label:"W",stacked:!1,hourly:[{suffix:"forecast_power_now_w",name:"forecast",color:Rt.solar,type:"area"},{suffix:"solar_power",name:"actual",color:Rt.batteryOut,type:"line"}]},battery:{title:"battery",y_label:"W",y2_label:"%",stacked:!1,hourly:[{suffix:"battery_power",name:"power",color:Rt.batteryOut,type:"area"},{suffix:"battery_soc",name:"soc",color:"#ff9800",type:"line",y_axis:1}]},ev:{title:"ev_charging",y_label:"W",stacked:!0,defaultPeriod:"today",y_min:0,y_suggested_max:2e3,hourly:[{suffix:"flow_solar_to_ev_power",name:"solar",color:Rt.solar,type:"area"},{suffix:"flow_battery_to_ev_power",name:"battery",color:Rt.batteryOut,type:"area"},{suffix:"flow_grid_to_ev_power",name:"grid",color:Rt.gridImport,type:"area"}],daily:[{suffix:"daily_ev_energy",name:"ev_energy",color:Rt.ev,type:"bar"}],monthly:[{suffix:"monthly_ev_energy",name:"ev_energy",color:Rt.ev,type:"bar"}]}};we("sem-chart-card",class extends Se{constructor(){super(),this._chart=null,this._period=null,this._fetchTimer=null,this._cachedChartTheme=null,this._boundPeriodHandler=e=>this._onPeriodChange(e.detail),this._prefix="sensor.sem_",this._preset=null,this._emptyMsg=""}setConfig(e){if(!e.preset&&!e.series)throw new Error("sem-chart-card requires either preset or series config");this._config=e,this._prefix=e.entity_prefix||"sensor.sem_",this._preset=e.preset?Ot[e.preset]:null,this.requestUpdate()}set hass(e){this._hass=e;const t=e?.language;if(t!==this._lang)return this._lang=t,void this.requestUpdate();this._period||this._setDefaultPeriod()}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),document.addEventListener("sem-period-change",this._boundPeriodHandler),this._rollInterval=setInterval(()=>this._rollRelativePeriod(),3e5),this._boundVisibility=()=>{document.hidden||this._rollRelativePeriod()},document.addEventListener("visibilitychange",this._boundVisibility)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("sem-period-change",this._boundPeriodHandler),this._boundVisibility&&document.removeEventListener("visibilitychange",this._boundVisibility),clearInterval(this._rollInterval),this._chart&&(this._chart.destroy(),this._chart=null),clearTimeout(this._fetchTimer)}_rollRelativePeriod(){if(!this._period||!this._hass)return;const e=this._config?.default_period||this._preset?.defaultPeriod,t="24h"===e?"24h":"7d"===e?"7d":"today"===e?"today":"week";this._period.key===t&&this._setDefaultPeriod()}firstUpdated(){this._period||this._setDefaultPeriod()}static get styles(){return[ke,a`
            :host { display: block; }
            .sem-chart-wrap {
                padding: 16px;
                min-height: 280px;
        ...
        <div class="device${r?" is-child":""}" data-id="${e.id}" style="${o}">
            ...
            <div class="ge-title" style="margin-top:10px">
                ...
                <a class="ge-docs" href="${ii}" target="_blank"
                   rel="noopener" title="${this._t("config_docs")}"
                   @click=${e=>e.stopPropagation()}>
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s=this._switchOn("observer_mode"),r={surplus:e=>this._renderSurplusSection(e),battery:e=>this._renderBatterySection(e),hotwater:e=>this._renderHotWaterSection(e),heatpump:e=>this._renderHeatPumpSection(e),tariff:e=>this._renderTariffSection(e),peak:e=>this._renderPeakSection(e)};return W`
            ...
            <div class="wrap">
                ...
                ${si.map(t=>this._renderSection(t,r[t.id],e))}
            </div>
        `}getCardSize(){return 12}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-control-card",name:"SEM Control Card",description:"Consolidated control panel for Solar Energy Management",preview:!1});class ai extends ce{static get properties(){return{hass:{type:Object},entryId:{type:String,attribute:"entry-id"},optionKey:{type:String,attribute:"option-key"},chargerIndex:{type:Number,attribute:"charger-index"},chargerKey:{type:String,attribute:"charger-key"},domain:{type:String},includeDeviceClass:{type:String,attribute:"include-device-class"},label:{type:String},_saving:{state:!0},_error:{state:!0}}}constructor(){super(),this.entryId="",this.optionKey="",this.chargerIndex=-1,this.chargerKey="",this.domain="",this.includeDeviceClass="",this.label="",this._saving=!1,this._error=""}static get styles(){return a`
        ...
        `}_renderPicker(e,t,i,s,r,a){const o=this._saveStatus[e],n=li.has(e),l=n&&Object.prototype.hasOwnProperty.call(this._pending,e),c=l?this._pending[e]:r[e]||"",d=t=>{n?(this._pending={...this._pending,[e]:t||""},this.requestUpdate()):this._saveOption(e,t,e)};return W`
            <div class="picker-cell">
                <div class="picker-row">
        ...
        `}_renderOptionToggle(e,t,i,s,r){const a=li.has(e),o="opt:"+e;a||this._reg(o);const n=a&&Object.prototype.hasOwnProperty.call(this._pending,e),l=null!=i[e]?!!i[e]:!!r,c=n||!a&&this._isDirty(o),d=n?!!this._pending[e]:!a&&this._isDirty(o)?!!this._staged[o].value:l;return W`
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s={overview:e=>this._renderOverview(e),sensor_sources:e=>this._renderSensorSources(e),ev_chargers:e=>this._renderEvChargers(e),battery_zones:e=>this._renderBatteryZones(e),tariff:e=>this._renderTariff(e),heat_pump:e=>this._renderHeatPump(e),hot_water:e=>this._renderHotWater(e),battery_scheduler:e=>this._renderBatteryScheduler(e),load_management:e=>this._renderLoadManagement(e),forecast:e=>this._renderForecast(e),pv_strings:e=>this._renderPvStrings(e),notifications:e=>this._renderNotifications(e),advanced:e=>this._renderAdvanced(e)};return W`
            ...
            <ha-card>
                <div class="wrap">
                    ...
                    ${oi.filter(e=>"pv_strings"!==e.id||this._pvStrings().length>=2).map(t=>this._renderSection(t,s[t.id],e))}
                </div>
            </ha-card>
        `}getCardSize(){return 12}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-config-card",name:"SEM Configuration Card",description:"In-dashboard SEM configuration surface (replaces the Settings → SEM → Configure flow for most users)",preview:!1});const ci="sem-config-tab-introduced-v1";we("sem-onboarding-banner",class extends Se{static get watchedEntities(){return[]}static get properties(){return{...super.properties,_dismissed:{state:!0}}}constructor(){super(),this._dismissed=this._isDismissed()}setConfig(e){super.setConfig(e),this._configPath=e.config_tab_path||"/config"}_isDismissed(){try{return"1"===localStorage.getItem(ci)}catch(e){return!1}}_dismiss(){try{localStorage.setItem(ci,"1")}catch(e){}this._dismissed=!0}_openConfig(){const e=window.location.pathname.split("/").filter(Boolean);if(e.length>=2){const t="/"+e.slice(0,-1).join("/");window.history.pushState(null,"",`${t}/config`)}else window.history.pushState(null,"",this._configPath);window.dispatchEvent(new Event("location-changed",{composed:!0})),this._dismiss()}render(){if(this._dismissed)return q;if(!this._config)return q;const e=this._theme(),t="#8DC892";return W`
            <style>
                :host { display: block; }
                .banner {
                    display: flex; align-items: center; gap: 12px;
        ...
        `}getCardSize(){return 1}static getStubConfig(){return{}}},{type:"custom:sem-onboarding-banner",name:"SEM Onboarding Banner",description:"One-time welcome banner pointing existing users to the new Configuration tab",preview:!1});class di extends Se{static get properties(){return{...super.properties,section:{type:String},label:{type:String},_open:{state:!0},_busy:{state:!0},_payload:{state:!0},_error:{state:!0},_copied:{state:!0}}}constructor(){super(),this.section="all",this.label="",this._open=!1,this._busy=!1,this._payload=null,this._error=null,this._copied=!1,this._copiedTimer=null}disconnectedCallback(){super.disconnectedCallback(),this._copiedTimer&&(clearTimeout(this._copiedTimer),this._copiedTimer=null)}static get watchedEntities(){return[]}async _click(){if(this._hass){this._open=!0,this._busy=!0,this._error=null,this._payload=null;try{const e=await this._hass.callService("solar_energy_management","diagnose",{section:this.section||"all"},void 0,void 0,!0);this._payload=e?.response||e}catch(e){this._error=e?.message||String(e),console.error("[sem-diagnose-button] failed",e)}finally{this._busy=!1}}}_close(){this._open=!1,this._copied=!1,this._payload=null,this._error=null}async _copy(){if(!this._payload)return;const e=JSON.stringify(this._payload,null,2),t=()=>{this._copied=!0,this._error=null,this._copiedTimer&&clearTimeout(this._copiedTimer),this._copiedTimer=setTimeout(()=>{this._copiedTimer=null,this._copied=!1},1500)};if(navigator?.clipboard?.writeText&&!1!==window.isSecureContext)try{return await navigator.clipboard.writeText(e),void t()}catch(e){console.warn("[sem-diagnose-button] modern clipboard refused, falling back to execCommand",e)}try{const i=document.createElement("textarea");i.value=e,i.setAttribute("readonly",""),i.style.position="fixed",i.style.top="0",i.style.left="0",i.style.width="1px",i.style.height="1px",i.style.opacity="0",document.body.appendChild(i),i.focus(),i.select();const s=document.execCommand("copy");if(document.body.removeChild(i),s)return void t();console.error('[sem-diagnose-button] execCommand("copy") returned false')}catch(e){console.error("[sem-diagnose-button] legacy clipboard fallback threw",e)}this._error=this._t("config_diagnose_clipboard_failed")}render(){const e=this._theme(),t=e.accent||"#5BC8D8",i=this.label||this._t("config_diagnose");return W`
            ...
            `:q}
        `}}customElements.get("sem-diagnose-button")||customElements.define("sem-diagnose-button",di),console.info("%c SEM Cards %c Lit Bundle ","color: #4db6ac; font-weight: bold; background: #1e232d; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #ff9800; background: #1e232d; padding: 2px 6px; border-radius: 0 4px 4px 0;");
