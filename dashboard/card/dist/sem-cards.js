                ...
                <div class="charger-body">
                    ...
                    <div class="charger-metrics">
                        <div class="cm-row">
                            ...
                            <span class="cm-value" style="color:${f?i:""}">${_e(s)}</span>
                        </div>
                        <div class="cm-row">
