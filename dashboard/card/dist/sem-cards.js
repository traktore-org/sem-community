                    ...
                    <div class="session-section">
                        ...
                        <div class="sess-grid">
                            ...
                            <div>
                                ...
                                <div class="sess-item-value">${_e(P)}</div>
                            </div>
                            <div>
            ...
            <ha-card>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}"
                    ...
                    <text x="${e.B.cx}" y="${e.B.labelY+1*r+s}"
                          ...
                          fill="${L}" opacity="0.6">${g?this._t("sensor_unavailable"):P}</text>
