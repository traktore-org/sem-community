                ...
                <div class="charge-target-group">
                    ...
                    <div class="ct-row">
                        <span class="ct-set-default"
                            @click=${()=>this._callService("button","press",{entity_id:B})}>
