            ...
            <div class="device-body">
                <div class="device-top">
                    ...
                    <div class="device-power" data-field="power-${e.id}">
                        ${s?W`<span style="opacity:0.7">${null!=e.soc?e.soc+"% · ":""}${i?he(1e3*e.power):this._t("off")}</span>`:i?he(1e3*e.power):e.isShed?this._t("shed_label"):e.rating>0?W`<span style="opacity:0.5" title="${this._t("rated_power_hint")}">~${he(e.rating)}</span>`:this._t("off")}
                    </div>
                </div>
                ...
                <div class="device-bottom">
                    ...
                    ${"ev_charger"===e.deviceType||"ev_charging"===e.deviceType||s||"surplus"!==this._mergedMode(e)?K:W`
