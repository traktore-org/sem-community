    ...
    `;getCardSize(){return this._inner?.getCardSize?.()||3}}be("sem-require",we,{type:"custom:sem-require",name:"SEM Require Wrapper",description:"Renders a card only when its HACS dependency is installed; otherwise a friendly install notice",preview:!1});const ke=(e,t)=>"function"==typeof semLocalize?semLocalize(e,t?.language):e,Se={home:{titleKey:"home",subtitleKey:"home_sub",color:"#5BC8D8",icon:()=>j`
            ...
            <ha-card>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}"
                    ...
                    <g class="flow-group" style="opacity:${he?1:0}">
                        ${this._renderFlow(!1,"#ff9800",ue(o),e.paths.solar,2)}
                    </g>
                    <g class="flow-group" style="opacity:${fe?1:0}">
                        ${this._renderFlow(me,ye,ue(d),e.paths.battery,3)}
                    </g>
                    <g class="flow-group" style="opacity:${be?1:0}">
                        ${this._renderFlow($e,we,ue(n||l),e.paths.grid,3)}
                    </g>
                    <g class="flow-group" style="opacity:${ke?1:0}">
                        ${this._renderFlow(!1,"#5BC8D8",ue(m),e.paths.home,2)}
                    </g>
                    <g class="flow-group" style="opacity:${Se?1:0}">
                        ${this._renderFlow(!1,"#8DC892",ue(c),e.paths.ev,3)}
                    </g>
        ...
        `)}_renderDeviceStrip(e){const t=this._eid("controllable_devices_count"),i=t?this._hass?.states[t]:void 0;if(!i?.attributes?.devices)return q;const s=Object.entries(i.attributes.devices).filter(([,e])=>"ev_charger"!==e.device_type&&"battery"!==e.device_type).map(([e,t])=>{const i=t.power_entity?this._hass.states[t.power_entity]:null,s=i?parseFloat(i.state)||0:t.current_power||0;return{id:e,...t,power:s}}).sort((e,t)=>t.power-e.power).slice(0,3);if(!s.length)return q;const r="'Segoe UI','Roboto',sans-serif",a=he;return s.map((t,i)=>{let s=(t.name||t.id).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");s.length>22&&(s=s.substring(0,21)+"…");const o=a[i%a.length],n=t.is_on||t.power>5,l=310+50*i,c=540,d=`M${e.cx+e.r},${e.cy+10+8*i} C${e.cx+e.r+40},${e.cy+30+15*i} 510,${l-10} 524,${l}`,p=t.power>5?j`
                <circle r="1.5" fill="${o}" opacity="0.8">
                    <animateMotion path="${d}" dur="${ue(t.power).toFixed(1)}s" repeatCount="indefinite" calcMode="paced"/>
                </circle>
            `:q;return j`
