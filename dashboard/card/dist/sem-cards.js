            ...
            <div class="charger-section">
                ...
                <div class="charge-target-group">
                    ...
                    <div class="ct-row">
                        ...
                        <span class="ct-ctl">
                            <span
                                ...
                                @click=${()=>this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:M}}))}
                            >${D}</span>
                            ${R}
                        </span>
                    </div>
                    <div class="ct-row">
                        ...
                        <span class="ct-ctl">${T(A,F)}</span>
                    </div>
                    <div class="ct-row">
                        <span class="ct-label">${this._t("night_charging")}</span>
                        <span class="ct-ctl">${T(I,w)}</span>
                    </div>
                </div>
