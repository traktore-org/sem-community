    ...
    `;getCardSize(){return this._inner?.getCardSize?.()||3}}be("sem-require",we,{type:"custom:sem-require",name:"SEM Require Wrapper",description:"Renders a card only when its HACS dependency is installed; otherwise a friendly install notice",preview:!1});const ke=(e,t)=>"function"==typeof semLocalize?semLocalize(e,t?.language):e,Se={home:{titleKey:"home",subtitleKey:"home_sub",color:"#5BC8D8",icon:()=>j`
                    ...
                    <div class="session-section">
                        <div class="sess-header">
                            <ha-icon icon="mdi:battery-sync"
                                style="--mdc-icon-size:14px;color:${A?H:e.textSec}">
                            </ha-icon>
                            <span class="sess-title" style="color:${A?H:e.textSec}">
                        ...
                        <div class="sess-grid">
                            ...
                            <div>
                                ...
                                <div class="sess-item-value">
                                    ${N?`${this._t("solar")}: ${this._fmt(L,0)}%`:""}
                                </div>
                            </div>
                            <div>
                                <div class="sess-item-label">${this._t("cost")}</div>
                                <div class="sess-item-value">
                                    ${N?`${this._fmt(O,2)} ${f}`:`${this._t("saved")} ${this._fmt(U,2)} ${f}`}
                                </div>
                            </div>
                        </div>
                        `:W``}
                ...
                <div class="wrap">
                    ...
                    <div class="section">
                        ...
                        <div class="metric-row">
                            ...
                            <span class="metric-val c-solar">${_e(N)}</span>
                        </div>
                        <div class="metric-row">
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s=this._switchOn("observer_mode"),r={surplus:e=>this._renderSurplusSection(e),battery:e=>this._renderBatterySection(e),hotwater:e=>this._renderHotWaterSection(e),heatpump:e=>this._renderHeatPumpSection(e),tariff:e=>this._renderTariffSection(e),peak:e=>this._renderPeakSection(e)};return W`
            ...
            <div class="wrap">
                ...
                ${Ht.map(t=>this._renderSection(t,r[t.id],e))}
            </div>
