...
`;class Se extends ce{constructor(){super(),this._hass=null,this._config=null,this._lang=null,this._localizeReady=!1,this._prevVals={},this._frozenEntities={},this._holdTimers={},this._holdIntervals={},this._cachedTheme=null,this._updateTimer=null}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;const r=this.constructor.watchedEntities||[];if(r.length>0&&!s){const t=e.states[r[0]]?.state;if("unavailable"===t||"unknown"===t)return}let a=!1;for(const t of r){const i=e.states[t]?.state;if(this._prevVals[t]!==i){a=!0;break}}if(a||s){for(const t of r)this._prevVals[t]=e.states[t]?.state;this._scheduleUpdate()}}get hass(){return this._hass}_scheduleUpdate(){this._updateTimer||(this._updateTimer=setTimeout(()=>{this._updateTimer=null,this.requestUpdate()},16))}_theme(){const e=getComputedStyle(document.documentElement).getPropertyValue("--primary-background-color").trim();return this._cachedTheme&&this._cachedThemeKey===e||(this._cachedThemeKey=e,this._cachedTheme=ye()),this._cachedTheme}_t(e){return e?"function"==typeof semLocalize?semLocalize(e,this._hass?.language):e:""}_forecastProviderLabel(e){if(!e)return"";return{solcast:"Solcast",forecast_solar:"Forecast.Solar",open_meteo:"Open-Meteo",custom:this._t("custom")||"Custom"}[e]||e}_state(e,t=0){const i=this._frozenEntities[e];if(i)return i.value;const s=this._hass?.states[e];return s&&"unavailable"!==s.state&&"unknown"!==s.state?parseFloat(s.state)??t:t}_stateStr(e){const t=this._frozenEntities[e];if(t)return String(t.value);const i=this._hass?.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:""}_pcEntity(e,t,i){const s=this._hass?.states||{},r=new RegExp(`^${e}\\.sem_charger_.+_${t}$`);let a=Object.keys(s).filter(e=>r.test(e));return"night_charging"===t&&(a=a.filter(e=>!e.endsWith("_smart_night_charging"))),a.sort(),a.length?a[0]:i}_stateAttrs(e){return this._hass?.states[e]?.attributes||{}}_freezeEntity(e,t){const i=this._frozenEntities[e];i?.timer&&clearTimeout(i.timer),this._frozenEntities[e]={value:t,timer:setTimeout(()=>{delete this._frozenEntities[e],this.requestUpdate()},1500)}}_isFrozen(){return Object.keys(this._frozenEntities).length>0}async _callService(e,t,i){if(this._hass)try{await this._hass.callService(e,t,i)}catch(e){console.error(`[SEM ${this.tagName}]`,e)}}_setNumber(e,t){const i=this._hass?.states[e];if(!i)return;const s=parseFloat(i.attributes.min)||0,r=parseFloat(i.attributes.max)||100,a=Math.max(s,Math.min(r,t));this._freezeEntity(e,a),this.requestUpdate(),this._callService("number","set_value",{entity_id:e,value:a})}_stepNumber(e,t){const i=this._hass?.states[e];if(!i)return;const s=this._frozenEntities[e],r=s?s.value:parseFloat(i.state)||0,a=parseFloat(i.attributes.step)||1;this._setNumber(e,r+t*a)}_toggleSwitch(e){const t=this._hass?.states[e];if(!t)return;const i="on"===t.state?"off":"on";this._freezeEntity(e,i),this.requestUpdate();const s="on"===t.state?"turn_off":"turn_on";this._callService("switch",s,{entity_id:e})}_selectOption(e,t){this._freezeEntity(e,t),this.requestUpdate(),this._callService("select","select_option",{entity_id:e,option:t})}_startHold(e,t){this._stopHold(e),this._holdTimers[e]=setTimeout(()=>{this._holdIntervals[e]=setInterval(()=>{this._stepNumber(e,t)},150)},400)}_stopHold(e){clearTimeout(this._holdTimers[e]),clearInterval(this._holdIntervals[e]),delete this._holdTimers[e],delete this._holdIntervals[e]}updated(){if(window._semDebug){this.style.outline="2px solid red",this.style.outlineOffset="-2px",clearTimeout(this._debugFlashTimer),this._debugFlashTimer=setTimeout(()=>{this.style.outline="",this.style.outlineOffset=""},200);const e=this.tagName.toLowerCase();window._semRenderLog||(window._semRenderLog={}),window._semRenderLog[e]=(window._semRenderLog[e]||0)+1}}connectedCallback(){super.connectedCallback(),window._semDebug&&console.log(`[SEM DEBUG] ${this.tagName} connectedCallback`),this._localizeReady||"function"==typeof semLocalize?"function"==typeof semLocalize&&(this._localizeReady=!0):(this._onLocalizeReady=()=>{document.removeEventListener("sem-localize-ready",this._onLocalizeReady),this._onLocalizeReady=null,this._localizeReady=!0,this._hass&&this.requestUpdate()},document.addEventListener("sem-localize-ready",this._onLocalizeReady))}disconnectedCallback(){super.disconnectedCallback(),window._semDebug&&console.log(`[SEM DEBUG] ${this.tagName} disconnectedCallback !!!`),this._onLocalizeReady&&(document.removeEventListener("sem-localize-ready",this._onLocalizeReady),this._onLocalizeReady=null),this._updateTimer&&(clearTimeout(this._updateTimer),this._updateTimer=null);for(const e of Object.keys(this._holdTimers))this._stopHold(e);for(const e of Object.keys(this._frozenEntities))clearTimeout(this._frozenEntities[e]?.timer);this._frozenEntities={}}setConfig(e){this._config=e}getCardSize(){return 4}static getStubConfig(){return{}}}we("sem-title-card",class extends Se{static get watchedEntities(){return[]}constructor(){super(),this._renderedSubtitle=null,this._templateUnsub=null,this._templateSubbed=!1}setConfig(e){super.setConfig(e),this._unsubTemplate(),this._templateSubbed=!1,this._renderedSubtitle=null}_hasJinja(e){return e&&(e.includes("{%")||e.includes("{{"))}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;(t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,this.requestUpdate()),this._hasJinja(this._config?.subtitle)&&!this._templateSubbed&&this._subscribeTemplate()}_subscribeTemplate(){if(!this._hass?.connection||this._templateSubbed)return;this._templateSubbed=!0;const e=this._config.subtitle;this._hass.connection.subscribeMessage(e=>{const t=e.result;t!==this._renderedSubtitle&&(this._renderedSubtitle=t,this.requestUpdate())},{type:"render_template",template:e,variables:{}}).then(e=>{this._templateUnsub=e}).catch(()=>{this._renderedSubtitle=this._config.subtitle,this.requestUpdate()})}_unsubTemplate(){this._templateUnsub&&(this._templateUnsub(),this._templateUnsub=null)}disconnectedCallback(){super.disconnectedCallback(),this._unsubTemplate()}render(){if(!this._config)return q;const e=this._t(this._config.title_key||this._config.title||"");let t="";t=this._hasJinja(this._config.subtitle)?this._renderedSubtitle||"":this._t(this._config.subtitle||"");const i=this._theme();return W`
    ...
    `;getCardSize(){return this._inner?.getCardSize?.()||3}}we("sem-require",Ce,{type:"custom:sem-require",name:"SEM Require Wrapper",description:"Renders a card only when its HACS dependency is installed; otherwise a friendly install notice",preview:!1});const ze=(e,t)=>"function"==typeof semLocalize?semLocalize(e,t?.language):e,Me={home:{titleKey:"home",subtitleKey:"home_sub",color:"#5BC8D8",icon:()=>j`
        ...
        `}getCardSize(){return 1}static getStubConfig(){return{tab:"home"}}},{type:"sem-tab-header",name:"SEM Tab Header",description:"Lumina-styled tab header with glow icon and live stats"});const Ee={"clear-night":{icon:"🌙",key:"weather_clear"},cloudy:{icon:"☁️",key:"weather_cloudy"},fog:{icon:"🌫️",key:"weather_fog"},hail:{icon:"🧊",key:"weather_hail"},lightning:{icon:"⚡",key:"weather_thunder"},"lightning-rainy":{icon:"⛈️",key:"weather_thunderstorm"},partlycloudy:{icon:"⛅",key:"weather_partly_cloudy"},pouring:{icon:"🌧️",key:"weather_pouring"},rainy:{icon:"🌦️",key:"weather_rain"},snowy:{icon:"❄️",key:"weather_snow"},"snowy-rainy":{icon:"🌨️",key:"weather_sleet"},sunny:{icon:"☀️",key:"weather_sunny"},windy:{icon:"💨",key:"weather_windy"},"windy-variant":{icon:"💨",key:"weather_windy"},exceptional:{icon:"⚠️",key:"weather_exceptional"}};we("sem-weather-card",class extends Se{static get styles(){return[ke]}constructor(){super(),this._clockTime="--:--",this._clockDate="",this._clockInterval=null}static get watchedEntities(){return[]}setConfig(e){if(!e.entity)throw new Error("sem-weather-card requires entity");super.setConfig(e)}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;const r=this._config?.entity;if(!r)return;const a=e?.states[r],o=(a?.state||"")+JSON.stringify(a?.attributes?.forecast?.[0]||"")+"|"+(t||"");(o!==this._lastWeatherKey||s)&&(this._lastWeatherKey=o,this.requestUpdate())}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),this._updateClock(),this._clockInterval=setInterval(()=>{this._updateClock()},3e4)}disconnectedCallback(){super.disconnectedCallback(),this._clockInterval&&(clearInterval(this._clockInterval),this._clockInterval=null)}_updateClock(){const e=new Date,t=this._hass?.language||navigator.language||"en",i=this._hass?.config?.time_zone||void 0;this._clockTime=e.toLocaleTimeString(t,{hour:"2-digit",minute:"2-digit",timeZone:i}),this._clockDate=e.toLocaleDateString(t,{weekday:"long",day:"numeric",month:"long",year:"numeric",timeZone:i}),this.requestUpdate()}_renderForecastRows(e,t){const i=this._hass?.language||navigator.language||"en",s=this._hass?.config?.time_zone||void 0;return e.slice(0,t).map(e=>{const t=new Date(e.datetime).toLocaleDateString(i,{weekday:"short",timeZone:s}),r=Ee[e.condition]?.icon||"❓",a=null!=e.templow?Math.round(e.templow):"—",o=null!=e.temperature?Math.round(e.temperature):"—",n="number"==typeof o&&"number"==typeof a?o-a:0,l=Math.max(n/30*100,10),c="number"==typeof o&&"number"==typeof a?(a+o)/2:15,d=Math.min(Math.max((c-0)/30,0),1),p=d>.5?`rgba(255,${Math.round(200-100*d)},0,0.6)`:`rgba(${Math.round(100+200*d)},${Math.round(180+40*d)},255,0.5)`;return W`
            ...
            `;const s=this._theme(),r=i.state,a=i.attributes,o=null!=a.temperature?Math.round(a.temperature):"—",n=a.temperature_unit||"°C",l=null!=a.humidity?Math.round(a.humidity):"—",c=null!=a.wind_speed?Math.round(a.wind_speed):"—",d=a.wind_speed_unit||"km/h",p=Ee[r]||{icon:"❓",key:""},h=a.forecast||[];return W`
            <style>
                :host { display: block; }
                .wrap {
        ...
        `}getCardSize(){return 3}static getStubConfig(){return{entity_prefix:Fe}}},{type:"custom:sem-energy-impact-card",name:"SEM Energy Impact Card",description:"Environmental impact display for Solar Energy Management",preview:!1});const Ne="daily_ev_energy",Pe="lifetime_ev_energy",Ae="lifetime_ev_solar_share",Te="lifetime_ev_cost",Re="lifetime_ev_sessions",Le="sensor.sem_";we("sem-ev-progress-card",class extends Se{static get watchedEntities(){return[`${Le}${Ne}`,`${Le}${Pe}`,`${Le}${Ae}`,`${Le}${Te}`,`${Le}${Re}`,"number.sem_daily_ev_target","number.sem_charger_ev_charger_daily_ev_target"]}_evDailyTarget(){const e=this._hass?.states||{},t=Object.keys(e).filter(e=>/^number\.sem_charger_.+_daily_ev_target$/.test(e)).sort();if(t.length){const i=parseFloat(e[t[0]]?.state);if(!isNaN(i))return i}return this._state("number.sem_daily_ev_target",10)}setConfig(e){super.setConfig(e)}_prefix(){return this._config?.entity_prefix??Le}_pct(e,t){return t<=0?0:Math.min(100,e/t*100)}_barColor(e,t){return 0===e?"#666":t>=100?"#8DC892":t>=70?"#ff9800":"#f44336"}_fmtEnergy(e){return null==e||isNaN(e)?"—":e.toFixed(e<10?2:1)+" kWh"}_fmtCost(e,t){return null==e||isNaN(e)?"—":e.toFixed(2)+" "+t}_fmtSessions(e){return null==e||isNaN(e)?"—":String(Math.round(e))}render(){if(!this._hass||!this._config)return q;const e=this._theme(),t=this._prefix(),i=this._state(`${t}${Ne}`),s=this._evDailyTarget(),r=this._state(`${t}${Pe}`),a=this._state(`${t}${Ae}`),o=this._state(`${t}${Te}`),n=this._state(`${t}${Re}`),l=me(this._hass),c=this._pct(i,s),d=this._barColor(s,c),p=s>0?W`<span class="target-pct">${Math.round(c)}% ${this._t("of_target")}</span>`:W`<span class="target-pct no-target">${this._t("no_target")}</span>`,h=["radial-gradient(ellipse 80% 70% at 20% 50%, rgba(141,200,146,0.06) 0%, transparent 70%)",`radial-gradient(circle at 2px 2px, ${e.dotColor} 0.7px, transparent 0.7px)`].join(", ");return W`
            <style>
                :host {
                    display: block;
                    font-family: 'Segoe UI', 'Roboto', sans-serif;
        ...
        `}getCardSize(){return 5}static getStubConfig(){return{entity_prefix:Oe}}},{type:"sem-solar-card",name:"SEM Solar",description:"Consolidated solar production card with flows, forecast, and performance metrics"});const We=["sensor.sem_daily_solar_energy","sensor.sem_solar_power"];we("sem-solar-kpi-card",class extends Se{static get watchedEntities(){return We}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||"sensor.sem_"}_val(e,t=0){const i=this._hass?.states[`${this._prefix}${e}`];if(!i||"unavailable"===i.state||"unknown"===i.state)return t;const s=parseFloat(i.state);return Number.isFinite(s)?s:t}static get styles(){return a`
                :host { display: block; }
                .kpi {
                    display: flex;
                    align-items: center;
                    ...
                    <div class="session-section">
                        ...
                        <div class="sess-grid">
                            <div>
                                ...
                                <div class="sess-item-value">${this._fmt(A,2)} kWh</div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div class="sess-item-value">
                                    ${P?`${this._t("solar")}: ${this._fmt(L,0)}%`:""}
                                </div>
                            </div>
                            <div>
                                <div class="sess-item-label">${this._t("cost")}</div>
                                <div class="sess-item-value">
                                    ${P?`${this._fmt(O,2)} ${f}`:`${this._t("saved")} ${this._fmt(U,2)} ${f}`}
                                </div>
                            </div>
                        </div>
                        `:W``}
                ...
                <div class="wrap">
                    ...
                    <div class="section">
                        ...
                        <div class="metric-row">
                            ...
                            <span class="metric-val c-solar">${ge(P)}</span>
                        </div>
                        <div class="metric-row">
                            <span class="metric-label">${this._t("allocated")}</span>
                            <span class="metric-val">${ge(T)}</span>
                        </div>
                        <div class="metric-row">
                            <span class="metric-label">${this._t("unallocated")}</span>
                            <span class="metric-val c-green">${ge(A)}</span>
                        </div>
                        <div class="metric-row">
        ...
        `}getCardSize(){return 5}static getStubConfig(){return{entity_prefix:Xe}}},{type:"sem-grid-card",name:"SEM Grid",description:"Consolidated grid card with import/export, peak management, load control, tariff, and surplus"});const tt="sensor.sem_",it=20;function st(e){return 36+556*e}function rt(e){if(!e||"string"!=typeof e)return null;const t=e.match(/^(\d{1,2}):(\d{2})$/);if(!t)return null;const i=parseInt(t[1],10),s=parseInt(t[2],10);return i>24||s>59?null:(i+s/60)/24}function at(e){if(!Array.isArray(e))return[];const t=[];let i=-1;for(let s=0;s<24;s++)e[s]&&-1===i?i=s:e[s]||-1===i||(t.push({start:i/24,end:s/24}),i=-1);return-1!==i&&t.push({start:i/24,end:1}),t}we("sem-schedule-card",class extends Se{static get watchedEntities(){return[`${tt}tariff_current_import_rate`,`${tt}tariff_price_level`,`${tt}night_start_time`,`${tt}night_end_time`,`${tt}best_surplus_window`,`${tt}predicted_surplus_window`,`${tt}ev_power`,`${tt}charging_state`,`${tt}surplus_total_w`]}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||tt,this._selectedDay=this._selectedDay||"today"}_selectDay(e){["today","tomorrow"].includes(e)&&e!==this._selectedDay&&(this._selectedDay=e,this.requestUpdate())}set hass(e){this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;const r=["tariff_current_import_rate","tariff_price_level","night_start_time","night_end_time","best_surplus_window","predicted_surplus_window","ev_power","charging_state"].map(t=>{const i=e?.states[`${this._prefix}${t}`];return(i?.state||"")+JSON.stringify(i?.attributes?.schedule_today||"")+JSON.stringify(i?.attributes?.schedule_tomorrow||"")+JSON.stringify(i?.attributes?.tariff_schedule_today||"")+JSON.stringify(i?.attributes?.tariff_schedule_tomorrow||"")+JSON.stringify(i?.attributes?.today_plan||"")+JSON.stringify(i?.attributes?.tomorrow_plan||"")+JSON.stringify(i?.attributes?.schedule_surplus_hours||"")+JSON.stringify(i?.attributes?.schedule_ev_hours||"")}),a=r.join("|")+"|"+t;(a!==this._lastSchedKey||s)&&(this._lastSchedKey=a,this._scheduleUpdate())}get hass(){return this._hass}_stateObj(e){return this._hass?.states[`${this._prefix}${e}`]||null}_getTariffSchedule(){const e=this._stateObj("tariff_current_import_rate")||this._stateObj("tariff_price_level"),t=this._stateObj("tariff_price_level")?.state;return et(e?.attributes||{},this._selectedDay||"today",t).blocks}_getNightWindow(){const e=rt(this._stateObj("night_start_time")?.state),t=rt(this._stateObj("night_end_time")?.state);return null==e||null==t?null:{start:e,end:t}}_getPredictedSurplusWindow(){const e="tomorrow"===this._selectedDay;for(const t of["predicted_surplus_window","best_surplus_window"]){let i=this._stateObj(t)?.state;if(!i||"unknown"===i||"unavailable"===i)continue;const s=i.toLowerCase().startsWith("tomorrow");if(e!==s)continue;s&&(i=i.replace(/^tomorrow\s*/i,""));const r=i.split(/[-–]/);if(2!==r.length)continue;const a=rt(r[0].trim()),o=rt(r[1].trim());if(null!=a&&null!=o)return{start:a,end:o}}return null}_getSurplusBlocks(){if("tomorrow"===this._selectedDay)return[];const e=this._hass?.states[`${this._prefix}surplus_total_w`];return at(e?.attributes?.schedule_surplus_hours)}_getEvBlocks(){if("tomorrow"===this._selectedDay)return[];const e=this._hass?.states[`${this._prefix}surplus_total_w`];return at(e?.attributes?.schedule_ev_hours)}_getEvPlanWindow(){const e=this._stateObj("charging_state"),t=this._selectedDay||"today",i="tomorrow"===t?e?.attributes?.tomorrow_plan:e?.attributes?.today_plan,s=new Date;return s.setHours(0,0,0,0),"tomorrow"===t&&s.setDate(s.getDate()+1),function(e,t){if(!(Array.isArray(e)&&t instanceof Date))return null;const i=new Date(t);i.setHours(0,0,0,0);const s=new Date(i);s.setDate(s.getDate()+1);const r=i.getTime(),a=s.getTime(),o=a-r,n=e=>{const t=new Date(e).getTime();return!Number.isFinite(t)||t<r||t>=a?null:(t-r)/o};let l,c,d,p;for(const t of e)"ev_charge_start"===t.kind?l=n(t.when):"ev_min_reached"===t.kind?(c=n(t.when),p=t.values?.kwh):"ev_deadline"===t.kind&&(d=n(t.when));const h=c??d,_=l??(null!=h?0:null);return null==_&&null==h&&null==d?null:{plan:null!=_&&null!=h&&h>_?[{start:_,end:h,kwh:p}]:[],deadlineFrac:d,minReachedFrac:c}}(i,s)}_getSolarIntensity(){const e="tomorrow"===this._selectedDay,t=e?this._stateObj("charging_state")?.attributes?.tomorrow_plan:null,i=Array.isArray(t)?t.find(e=>"solar_peak"===e.kind):null,s=i?.when?new Date(i.when):null;return function(e,t){const i=Number.parseFloat(t);if(!e||Number.isNaN(i)||i<.5)return null;const s=Je(String(e).slice(0,5));if(null==s)return null;const r=new Array(24).fill(0).map((e,t)=>{const i=t/24-s;return Math.exp(-i*i/(.26*.13))}),a=Math.max(...r);return r.map(e=>e/a)}((s&&Number.isFinite(s.getTime())?`${String(s.getHours()).padStart(2,"0")}:${String(s.getMinutes()).padStart(2,"0")}`:null)||this._stateObj(e?"forecast_peak_time_tomorrow":"forecast_peak_time_today")?.state||(e?null:this._stateObj("peak_time_today")?.state),parseFloat(this._stateObj(e?"forecast_tomorrow_kwh":"forecast_today_kwh")?.state||this._stateObj(e?"forecast_tomorrow":"forecast_today")?.state))}_getForecastKwh(){const e="tomorrow"===this._selectedDay;return parseFloat(this._stateObj(e?"forecast_tomorrow_kwh":"forecast_today_kwh")?.state||this._stateObj(e?"forecast_tomorrow":"forecast_today")?.state)}_getSelectedDayStatus(){if("tomorrow"!==this._selectedDay)return"final";const e=this._stateObj("tariff_current_import_rate")||this._stateObj("tariff_price_level");return et(e?.attributes||{},"tomorrow",this._stateObj("tariff_price_level")?.state).status}_isEvCharging(){const e=parseFloat(this._stateObj("ev_power")?.state);if(!isNaN(e)&&e>10)return!0;const t=this._stateObj("charging_state")?.state;return t&&"charging"===t.toLowerCase()}_getNowBadges(){const e=this._stateObj("tariff_price_level")?.state,t=["cheap","normal","expensive","very_cheap","very_expensive"].includes(e)?e:null,i=["active","target_reached"].includes(this._stateObj("night_charging_status")?.state),s=parseFloat(this._stateObj("solar_power")?.state),r=!isNaN(s)&&s>50?`${(s/1e3).toFixed(1)} kW`:null,a=this._isEvCharging(),o=this._getEvPlanWindow();return{tariff:t,night:i?"now":null,surplus:r,ev:a?"charging":o?.plan?.length?"planned":null}}_buildSvgContent(e){const t=pe,i=e.textSec||"#888",s=e.textTertiary||"#777",r=e.surface||"rgba(255,255,255,0.03)";let a="";for(let e=0;e<=24;e+=2){const t=st(e/24);a+=`<text x="${t}" y="12" text-anchor="middle" fill="${i}"\n                font-size="10" font-family="'Segoe UI','Roboto',sans-serif"\n                font-variant-numeric="tabular-nums">${e.toString().padStart(2,"0")}</text>`}[this._t("tariff"),this._t("night"),this._t("surplus"),this._t("ev")].forEach((e,t)=>{a+=`<text x="32" y="${it+22*t+9+3.5}" text-anchor="end" fill="${s}"\n                font-size="10" font-family="'Segoe UI','Roboto',sans-serif">${e}</text>`});for(let e=0;e<4;e++){a+=`<rect x="36" y="${it+22*e}" width="556" height="18" rx="3" fill="${r}"/>`}const o={cheap:{fill:"#66bb6a",opacity:.62},normal:{fill:t.solar,opacity:.55},expensive:{fill:"#e91e63",opacity:.9}},n={cheap:"cheap",normal:"normal",expensive:"expensive"};for(const e of this._getTariffSchedule()){const t=st(e.start),i=st(e.end)-t,s=o[e.level]||o.normal,r=!0===e.isFallback,l=r?.35*s.opacity:s.opacity,c=r?` stroke="${s.fill}" stroke-width="1" stroke-opacity="0.6" stroke-dasharray="3,2"`:"",d=r?`${e.level} (no per-hour data — showing current level)`:null!=e.avgPrice?`${e.level} · avg ${e.avgPrice.toFixed(2)}`:e.level;if(a+=`<rect x="${t}" y="20" width="${i}" height="18"\n                rx="3" fill="${s.fill}" opacity="${l}"${c}>\n                <title>${d}</title></rect>`,i>30){const s=e.level&&n[e.level]?n[e.level]:e.type.toLowerCase();a+=`<text x="${t+i/2}" y="32.5" text-anchor="middle"\n                    fill="rgba(255,255,255,0.92)" font-size="9" font-weight="600"\n                    font-family="'Segoe UI','Roboto',sans-serif">${this._t(s)}</text>`}}const l=this._getNightWindow();if(l){const e=e=>{const t=Math.round(24*e*60);return`${String(Math.floor(t/60)).padStart(2,"0")}:${String(t%60).padStart(2,"0")}`},t=`${this._t("night")} ${e(l.start)}–${e(l.end)}`;if(l.start>l.end){const e=st(l.start);a+=`<rect x="${e}" y="42" width="${st(1)-e}"\n                    height="18" rx="3" fill="#42a5f5" opacity="0.55"><title>${t}</title></rect>`,a+=`<rect x="${st(0)}" y="42"\n                    width="${st(l.end)-st(0)}" height="18"\n                    rx="3" fill="#42a5f5" opacity="0.55"><title>${t}</title></rect>`}else{const e=st(l.start),i=st(l.end)-e;a+=`<rect x="${e}" y="42" width="${i}" height="18"\n                    rx="3" fill="#42a5f5" opacity="0.55"><title>${t}</title></rect>`}}const c=this._getSolarIntensity(),d=this._getForecastKwh();if(c){const e=isNaN(d)?this._t("surplus"):`${this._t("surplus")} · forecast ${d.toFixed(1)} kWh`;for(let t=0;t<24;t++){const i=c[t];if(i<.08)continue;const s=st(t/24),r=st(1/24);a+=`<rect x="${s}" y="64" width="${r}" height="18"\n                    fill="#fdd835" opacity="${(.55*i).toFixed(2)}"><title>${e}</title></rect>`}}const p=this._getPredictedSurplusWindow();if(p){const e=st(p.start),t=Math.max(0,st(p.end)-e);a+=`<rect x="${e}" y="64" width="${t}" height="18"\n                rx="3" fill="none" stroke="#fdd835" stroke-width="1"\n                stroke-opacity="0.5" stroke-dasharray="2,2"/>`}for(const e of this._getSurplusBlocks()){const t=st(e.start),i=Math.max(0,st(e.end)-t);a+=`<rect x="${t}" y="64" width="${i}" height="18"\n                rx="3" fill="#fdd835" opacity="0.62"/>`}const h=this._getEvPlanWindow();if(h?.plan?.length)for(const e of h.plan){const i=st(e.start),s=Math.max(0,st(e.end)-i),r=e.kwh?`${this._t("plan_ev_charge_start")} → ${this._t("plan_ev_min_reached").replace("{kwh}",e.kwh)}`:this._t("plan_ev_charge_start");a+=`<rect x="${i}" y="86" width="${s}" height="18"\n                    rx="3" fill="${t.ev}" opacity="0.30"\n                    stroke="${t.ev}" stroke-width="0.6" stroke-opacity="0.6"\n                    stroke-dasharray="3,2"><title>${r}</title></rect>`}for(const e of this._getEvBlocks()){const i=st(e.start),s=Math.max(0,st(e.end)-i);a+=`<rect x="${i}" y="86" width="${s}" height="18"\n                rx="3" fill="${t.ev}" opacity="0.55"/>`}if(null!=h?.deadlineFrac){const e=st(h.deadlineFrac);a+=`<line x1="${e}" y1="84" x2="${e}" y2="106"\n                stroke="#f06292" stroke-width="1.2" stroke-dasharray="2,1" opacity="0.85">\n                <title>${this._t("plan_ev_deadline")}</title></line>`}if("tomorrow"!==this._selectedDay&&this._isEvCharging()){const e=new Date,i=(e.getHours()+e.getMinutes()/60)/24,s=.5/24,r=Math.max(0,i-s),o=Math.min(1,i+s),n=st(r),l=st(o)-n;a+=`<rect x="${n}" y="86" width="${l}" height="18"\n                rx="3" fill="${t.ev}" opacity="0.95"/>`}if("tomorrow"!==this._selectedDay){const e=new Date,t=st((e.getHours()+e.getMinutes()/60)/24),i=18;a+=`<line x1="${t}" y1="${i}" x2="${t}" y2="${104}"\n                stroke="#ef5350" stroke-width="1.5" stroke-linecap="round" opacity="0.9"/>`,a+=`<polygon points="${t-3},${i} ${t+3},${i} ${t},${i+4}"\n                fill="#ef5350" opacity="0.9"/>`}return a}render(){if(!this._hass||!this._config)return q;const e=this._theme(),t=e.dotColor||"rgba(128,128,128,0.04)",i=this._buildSvgContent(e),s="tomorrow"===this._selectedDay,r=this._getSelectedDayStatus(),a=s&&"final"!==r,o=this._getNowBadges(),n={cheap:"#66bb6a",very_cheap:"#66bb6a",normal:"#ff9800",expensive:"#e91e63",very_expensive:"#e91e63",now:"#42a5f5",charging:"#8DC892",planned:"#8DC892"},l=(e,t)=>{if(!t)return q;const i=n[t]||"#888",s=/\d/.test(t)?t:this._t(t);return W`<span class="now-badge"
                ...
                <div class="wrap">
                    <div class="schedule-head">
                        <div class="day-tabs" role="tablist" aria-label="${this._t("schedule_day")}">
                            <button class="day-tab ${s?"":"active"}"
                                role="tab" aria-selected="${s?"false":"true"}"
                                @click=${()=>{this._selectedDay="today",this._scheduleUpdate()}}>
                                ${this._t("today")}
                            </button>
                            <button class="day-tab ${s?"active":""}"
                                role="tab" aria-selected="${s?"true":"false"}"
                                @click=${()=>{this._selectedDay="tomorrow",this._scheduleUpdate()}}>
                                ${this._t("tomorrow")}
                            </button>
                        </div>
                        ${s?W`
                            <div class="schedule-status ${a?"":"final"}" role="status">
                                <strong>${this._t(a?"schedule_preliminary":"schedule_final")}</strong>
                                ${a?this._t("schedule_preliminary_hint"):q}
                            </div>
                        `:q}
                    </div>
                    ...
                    ${s?q:W`
                        <div class="now-row" role="status">
                            ...
                            <span class="row-pair"><span>${this._t("tariff")}</span>${l(0,o.tariff)}</span>
                            <span class="row-pair"><span>${this._t("night")}</span>${l(0,o.night)}</span>
                            <span class="row-pair"><span>${this._t("surplus")}</span>${l(0,o.surplus)}</span>
                            <span class="row-pair"><span>${this._t("ev")}</span>${l(0,o.ev)}</span>
                        </div>
                    `}
                    <div class="legend">
        ...
        `}getCardSize(){return 2}static getStubConfig(){return{}}},{type:"sem-schedule-card",name:"SEM Schedule",description:"24-hour timeline showing tariff, night window, surplus window, and EV charging periods"});const ot=[{id:"autostart",entity:"number.sem_battery_auto_start_soc",icon:"mdi:play-circle",labelKey:"auto_start_soc",helpKey:"zone_help_autostart",color:"#4db6ac"},{id:"buffer",entity:"number.sem_battery_buffer_soc",icon:"mdi:shield-half-full",labelKey:"buffer_soc",helpKey:"zone_help_buffer",color:"#ff9800"},{id:"priority",entity:"number.sem_battery_priority_soc",icon:"mdi:shield-alert",labelKey:"priority_soc",helpKey:"zone_help_priority",color:"#f44336"}];we("sem-battery-zones-card",class extends Se{static get watchedEntities(){return ot.map(e=>e.entity)}static get properties(){return{...super.properties,_showHelp:{state:!0}}}constructor(){super(),this._showHelp=!1}_toggleHelp(){this._showHelp=!this._showHelp}setConfig(e){super.setConfig(e)}_getDecimalsForZone(e){const t=this._hass?.states[e];return(t&&parseFloat(t.attributes.step)||1)<1?1:0}_renderZoneMarkers(e){return ot.map(t=>{const i=this._state(t.entity),s=Math.max(0,Math.min(100,i));return W`
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=this._state(ot[0].entity),i=this._state(ot[1].entity),s=this._state(ot[3].entity),r=`${this._t("auto_start_soc")} ${t.toFixed(0)}% · Buffer ${i.toFixed(0)}% · ${this._t("priority_soc")} ${s.toFixed(0)}%`;return W`
            <style>
                :host { display: block; contain: layout style paint; }
                .wrap {
                    padding: 16px;
        ...
        `}render(){if(!this._config||!this._hass)return q;const e=me(this._hass);return W`
            <div class="wrap">
                ${dt.map(t=>this._renderSection(t,e))}
            </div>
        `}static get styles(){return a`
            :host { display: block; }
            .wrap {
        ...
        `}getCardSize(){return 8}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-costs-detail-card",name:"SEM Costs Detail Card",description:"Financial details — EV economics, investment, demand charge, and tariff rates",preview:!1});const pt="sensor.sem_";we("sem-charger-status-card",class extends Se{constructor(){super(),this._chargers=[],this._lastStateCount=0}set hass(e){this._hass,this._hass=e;const t=e?.language,i="function"==typeof semLocalize;let s=!1;if((t!==this._lang||i&&!this._localizeReady)&&(this._lang=t,this._localizeReady=i,s=!0),this._isFrozen()&&!s)return;if(this._chargers?.length>0&&!s){const t=this._config?.entity_prefix||pt,i=e.states[`${t}charger_${this._chargers[0]}_power`]?.state;if("unavailable"===i||"unknown"===i)return}const r=Object.keys(e.states).length;if(r!==this._lastStateCount){this._lastStateCount=r;const t=[];for(const i of Object.keys(e.states)){if(i.includes("_flow_"))continue;const e=i.match(/^sensor\.sem_charger_(.+)_power$/);e&&t.push(e[1])}this._chargers=t}const a=this._config?.entity_prefix||pt,o=this._chargers.map(t=>[`charger_${t}_power`,`charger_${t}_session_energy`,`charger_${t}_session_solar_share`,`charger_${t}_taper_trend`].map(t=>e.states[`${a}${t}`]?.state||"").join(":")).join("|");(o!==this._lastKey||s)&&(this._lastKey=o,this._scheduleUpdate())}get hass(){return this._hass}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||pt}_val(e,t=0){const i=this._hass?.states[`${this._prefix}${e}`];return i&&"unavailable"!==i.state&&"unknown"!==i.state?parseFloat(i.state)??t:t}_valStr(e){const t=this._hass?.states[`${this._prefix}${e}`];return t&&"unavailable"!==t.state&&"unknown"!==t.state?t.state:""}_chargerName(e){const t=this._hass?.states[`${this._prefix}charger_${e}_power`];let i=e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase());return t?.attributes?.friendly_name&&(i=t.attributes.friendly_name.replace(/^SEM\s+/i,"").replace(/\s+Power$/i,"")),i}_renderChargerTile(e){const t=this._val(`charger_${e}_power`),i=this._val(`charger_${e}_session_energy`),s=this._val(`charger_${e}_session_solar_share`),r=this._valStr(`charger_${e}_taper_trend`)||"stable",a=this._t(r),o=this._chargerName(e),n=t>50,l=n?"#8DC892":"#888",c=n?this._t("charging"):this._t("idle");return W`
        ...
        `}getCardSize(){return this._chargers.length>=1?3+2*this._chargers.length:3}static getStubConfig(){return{}}},{type:"sem-ev-status-card",name:"SEM EV Status",description:"Lumina-styled EV charging hero card with per-charger intelligence and settings"});const gt=["sensor.sem_solar_power","sensor.sem_battery_soc","sensor.sem_autarky_rate","sensor.sem_ev_power","sensor.sem_energy_optimization_score","sensor.sem_energy_tip","sensor.sem_best_surplus_window","sensor.sem_forecast_remaining_today_kwh","sensor.sem_current_vs_peak_percentage","sensor.sem_consecutive_peak_15min","sensor.sem_target_peak_limit","sensor.sem_daily_co2_avoided","sensor.sem_lifetime_co2_avoided"];we("sem-home-status-card",class extends Se{static get watchedEntities(){return gt}setConfig(e){super.setConfig(e),this._prefix=e.entity_prefix||"sensor.sem_"}_val(e,t=0){const i=this._hass?.states[`${this._prefix}${e}`];return i&&"unavailable"!==i.state&&"unknown"!==i.state?parseFloat(i.state)??t:t}_valStr(e){const t=this._hass?.states[`${this._prefix}${e}`];return t&&"unavailable"!==t.state&&"unknown"!==t.state?t.state:""}_scoreColor(e){return e>=80?"#8DC892":e>=50?"#ff9800":"#f44336"}_peakColor(e){return e>90?"#f44336":e>70?"#ff9800":"#8DC892"}_peakStatusKey(e){return e>90?"peak_critical":e>70?"peak_warning":"peak_safe"}_renderChip(e,t,i){return W`
            <div class="chip">
        ...
        `}getCardSize(){return 5}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-home-status-card",name:"SEM Home Status Card",description:"Consolidated status panel for the SEM Home tab",preview:!1});const ut="sensor.sem_tariff_current_import_rate",ft={negative:{color:"#4db6ac",key:"price_negative"},very_cheap:{color:"#8DC892",key:"very_cheap"},cheap:{color:"#8DC892",key:"cheap"},normal:{color:"#ff9800",key:"normal"},expensive:{color:"#f06292",key:"expensive"},very_expensive:{color:"#e53935",key:"very_expensive"}};we("sem-price-card",class extends Se{constructor(){super(),this._boundVisibility=()=>{document.hidden||this.requestUpdate()}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this._boundVisibility)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this._boundVisibility)}setConfig(e){super.setConfig(e),this._entity=e.entity||ut,this._compact=!!e.compact}set hass(e){this._hass=e;const t=e?.states[this._entity],i=t?.attributes||{},s=[t?.state,i.price_level,i.next_cheap_start,(i.upcoming||[]).length,this._lang].join("|"),r="function"==typeof semLocalize;(s!==this._lastKey||r&&!this._localizeReady)&&(this._lastKey=s,this._lang=e?.language,this._localizeReady=r,this.requestUpdate())}get hass(){return this._hass}_hm(e){if(!e)return null;const t=this._hass?.config?.time_zone||void 0;try{return new Date(e).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",timeZone:t})}catch(e){return null}}_levelInfo(e){return ft[e]||{color:"#9e9e9e",key:"normal"}}render(){if(!this._hass||!this._config)return q;const e=this._hass.states[this._entity];if(!e||"unavailable"===e.state||"unknown"===e.state)return W`<ha-card><div class="wrap empty">${this._t("current_electricity_price")}: —</div></ha-card>`;const t=e.attributes||{};if(!1===t.is_dynamic)return this.style.display="none",q;this.style.display="";const i=parseFloat(e.state),s=t.currency||"",r=this._levelInfo(t.price_level),a=e=>null==e||isNaN(e)?"—":Number(e).toFixed(2),o=Array.isArray(t.upcoming)?t.upcoming:[],n=this._hm(t.next_cheap_start),l=this._hm(t.next_cheap_end);return this._compact?W`
                <ha-card>
                    <div class="chip-row">
        ...
        `}getCardSize(){return 2}static getStubConfig(){return{entity:ut}}static get styles(){return a`
        ...
        `}_renderHealthSection(e){return W`
            <div class="health-chips">
                ${yt.map(e=>{const t=`${this._prefix}${e.key}`,i=this._available(t),s=this._hass?.states[t],r=s?s.state:"—";let a=e.suffix;if("tariff_current_import_rate"===e.key){const e=s?.attributes?.currency;a=e?` ${e}/kWh`:""}return W`
        ...
        `}getCardSize(){return 8}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-system-card",name:"SEM System Card",description:"Consolidated system panel for Solar Energy Management",preview:!1});const xt={now:{icon:"mdi:clock-outline",color:"#5BC8D8"},solar_peak:{icon:"mdi:weather-sunny",color:"#ff9800"},solar_end:{icon:"mdi:weather-sunset",color:"#ff9800"},cheap_start:{icon:"mdi:arrow-down-bold",color:"#8DC892"},cheap_end:{icon:"mdi:arrow-up-bold",color:"#ff9800"},expensive_start:{icon:"mdi:flash-alert",color:"#f06292"},expensive_end:{icon:"mdi:flash-off",color:"#8DC892"},night_open:{icon:"mdi:weather-night",color:"#8353d1"},night_end:{icon:"mdi:weather-sunset-up",color:"#ff9800"},ev_charge_start:{icon:"mdi:ev-station",color:"#8DC892"},ev_min_reached:{icon:"mdi:battery-charging-80",color:"#4db6ac"},ev_target_reached:{icon:"mdi:car-electric",color:"#8DC892"},ev_deadline:{icon:"mdi:clock-end",color:"#f06292"},ev_wait:{icon:"mdi:pause-circle",color:"#8353d1"},battery_full:{icon:"mdi:battery-charging-100",color:"#f06292"},battery_empty:{icon:"mdi:battery-low",color:"#4db6ac"},device_run:{icon:"mdi:power-plug",color:"#5BC8D8"},device_done:{icon:"mdi:check-circle",color:"#8DC892"}};we("sem-today-plan-card",class extends Se{setConfig(e){super.setConfig(e),this._entity=e.entity||"sensor.sem_charging_state"}set hass(e){this._hass=e;const t=(e?.states[this._entity]?.attributes||{}).today_plan||[],i=[t.length,t[0]?.when,t.at(-1)?.when,this._lang].join("|"),s="function"==typeof semLocalize;(i!==this._lastKey||s&&!this._localizeReady)&&(this._lastKey=i,this._lang=e?.language,this._localizeReady=s,this.requestUpdate())}get hass(){return this._hass}_hm(e){if(!e)return"—";try{const t=new Date(e),i=this._hass?.config?.time_zone||void 0,s=ue(e,i),r=e=>e.toLocaleDateString("en-CA",{timeZone:i}),a=r(t),o=new Date;if(a===r(o))return s;if(a===r(new Date(o.getTime()+864e5))){return`${this._t("tomorrow")||"Tomorrow"} ${s}`}return`${t.toLocaleDateString([],{weekday:"short",timeZone:i})} ${s}`}catch(e){return"—"}}_format(e,t){let i=this._t(e);if(!i||i===e)return null;for(const[e,s]of Object.entries(t||{}))i=i.replace(new RegExp(`\\{${e}\\}`,"g"),s);return i}render(){if(!this._hass||!this._config)return q;const e=this._hass.states[this._entity],t=e?.attributes?.today_plan||[];return!Array.isArray(t)||t.length<=1?(this.style.display="none",q):(this.style.display="",W`
            <ha-card>
                <div class="wrap">
                    ...
                    <ul class="rows">
                        ${t.map(e=>{const t=xt[e.kind]||xt.now,i=this._format(e.label,e.values)||e.label,s=e.detail?this._format(e.detail,e.values):null;return W`
        ...
        `}render(){if(!this._config)return q;const e=this._getLayout(),t=e.solar,i=e.inverter,s=e.battery,r=e.grid,a=e.home,o=e.ev,n=(2*Math.PI*e.socR).toFixed(1),l=(2*Math.PI*e.autarkyR).toFixed(1),c=e.font.label,d=e.font.value,p=e.font.sub,h=e.font.homeVal,_="'Segoe UI','Roboto',sans-serif",g=this._getNodeColor("grid_import"),u=this._getNodeColor("grid_export"),f=this._getNodeColor("solar"),m=this._getNodeColor("battery"),y=this._getNodeColor("home"),v=this._getNodeColor("ev"),x=zt.inverter.color,b=this._hasNode("solar"),$=this._hasNode("battery"),w=this._hasNode("grid"),k=this._hasNode("ev"),S=this._showInverter&&this._hasNode("inverter"),C=be(this._hass,this._prefix);return W`
            <ha-card>
                <style>${$e}</style>
                ${C.length>=2?W`
                    <div class="pv-strings-row">
        ...
        `}render(){if(!this._config)return q;const e=this._getLayout(),t=this._compact,i="'Segoe UI','Roboto',sans-serif",s=e.font.label,r=e.font.value,a=e.font.sub,o=this._flowSolar(),{gridImport:n,gridExport:l}=this._flowGridPair(),c=this._flowEv();let d,p;this._entities?.battery?.charge||this._entities?.battery?.discharge?(d=this._flowBattery(),p=!1):(({value:d,stale:p}=this._readWithHold("battery_power","this._lastBattPower",6e4)),this._entities?.battery?.reverse&&(d=-d));const{value:h,stale:_}=this._readWithHold("battery_soc","this._lastBattSoc",6e4),g=p||_,u=Math.max(0,d),f=Math.max(0,-d),m=this._flowHome(o,n,l,u,f,c),y=this._computeSunPose(),{isNight:v}=y,x=v?this._computeMoonPhase():{k:0,waxing:!0},b=v?.3:.85,$=o>50?Math.min(1,.3+o/5e3):0,w=this._hass?.states["sun.sun"]?.attributes,k=this._hass?.config?.time_zone||void 0,S=w?.next_rising?ue(w.next_rising,k):"",C=w?.next_setting?ue(w.next_setting,k):"",z=ye(this).isDark,M=z?"#FCD170":"#a06a00",E=z?.45:.8,D=z?"#ff9800":"#b35c00",F=z?.4:.8,I=z?"#96CAEE":"#3d6e94",B=z?.6:.85,N=z?.35:.8,P=e.B.r/50,A=64*P,T=A-12*P,R=e.B.cy-A/2+8*P,L=Math.max(0,Math.min(T,T*(h/100))),O=R+T-L,U=u>10?"#f06292":"url(#battFillGrad)",H=u>10,G=l>n?"#8353d1":"#488fc2",K=l>10&&l>n?this._t("exporting"):n>10?this._t("importing"):"",V=l>10&&l>n?"#8353d1":"#488fc2",Y=u>10?"#f06292":"#4db6ac",X=u>10?this._t("charging"):f>10?this._t("discharging"):"",Z=u>10?"#f06292":"#4db6ac",J="on"===this._hass?.states["binary_sensor.sem_ev_connected"]?.state;let Q="",ee="#8DC892";"on"===this._hass?.states["binary_sensor.sem_ev_charging"]?.state||c>10?(Q=this._t("charging"),ee="#8DC892"):J&&(Q=this._t("connected")||"Verbunden",ee="rgba(141,200,146,0.6)");const te=this._t("today"),ie=`${te} ${this._valStr("daily_solar_energy")} kWh`,se=this._val("forecast_today_kwh"),re=se>0?`☀ ${se.toFixed(1)} kWh ${this._t("forecast")||"Forecast"}`:"",ae=`${te} ${this._valStr("daily_ev_energy")} kWh`,oe=`${te} ${this._val("daily_home_energy").toFixed(1)} kWh`,ne=`+${this._val("daily_battery_charge_energy").toFixed(1)} / -${this._val("daily_battery_discharge_energy").toFixed(1)} kWh`,le=`↓${this._val("daily_grid_import_energy").toFixed(1)} / ↑${this._val("daily_grid_export_energy").toFixed(1)} kWh`,ce=this._valStr("inverter_temperature"),de=""===ce||isNaN(parseFloat(ce))?"":`${parseFloat(ce).toFixed(0)}°C`,pe=this._valStr("charging_state"),he=t?22:30,_e=pe.length>he?pe.substring(0,he-1)+"…":pe,me=[],ve=["solar_power","grid_import_power","grid_export_power"];this._showBattery&&ve.push("battery_power","battery_soc"),this._showEv&&ve.push("ev_power");for(const e of ve){const t=this._eid(e);if(!t){"prefix"===this._mode&&me.push(e);continue}const i=this._hass?.states[t];i&&"unavailable"!==i.state&&"unknown"!==i.state||me.push(e)}const xe=ge(this._solarDisp??0),we=(u>10?"↑ ":f>10?"↓ ":"")+ge(this._battDisp??0),ke=ge(this._homeDisp??0),Se=ge(this._evDisp??0),Ce=this._gridDispMode?`${this._gridDispMode} ${ge(this._gridDisp??0)}`:ge(0),ze="↑"===this._gridDispMode?"#8353d1":"#488fc2",Me=be(this._hass,this._prefix),Ee=o>10,De=Math.abs(d)>10,Fe=d<0,Ie=u>10?"#f06292":"#4db6ac",Be=n>10||l>10,Ne=n>l,Pe=l>n?"#8353d1":"#488fc2",Ae=m>10,Te=c>10;return W`
            <ha-card>
                <style>${$e}</style>
                ${Me.length>=2?W`
                    <div class="pv-strings-row">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}"
                    ...
                    <g>
                        ...
                        <text x="${e.sunRisingX}" y="${e.sunLabelY}"
                              ...
                              fill="${M}" opacity="${E}">${S}</text>
                        <text x="${e.sunSettingX}" y="${e.sunLabelY}"
                              text-anchor="middle" font-family="${i}" font-size="${a}"
                              fill="${M}" opacity="${E}">${C}</text>
                    ...
                    ${this._showBattery?j`<g class="flow-group" style="opacity:${De?1:0}">
                        ${this._renderFlow(Fe,Ie,fe(d),e.paths.battery,3)}
                    </g>`:q}
                    <g class="flow-group" style="opacity:${Be?1:0}">
                        ${this._renderFlow(Ne,Pe,fe(n||l),e.paths.grid,3)}
                    </g>
                    <g class="flow-group" style="opacity:${Ae?1:0}">
                        ${this._renderFlow(!1,"#5BC8D8",fe(m),e.paths.home,2)}
                    </g>
                    ${this._showEv?j`<g class="flow-group" style="opacity:${Te?1:0}">
                    ...
                    <text x="${e.S.cx}" y="${e.S.labelY+1.1*r}" class="clickable"
                          ...
                          font-weight="800" fill="#ff9800">${xe}</text>
                    ...
                    <text x="${e.S.cx}" y="${e.S.labelY+1.1*r+2*(a+3)}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${a}"
                          fill="${D}" opacity="${F}" font-weight="500">${re}</text>
                    ...
                    <text x="${e.I.cx}" y="${e.I.cy+e.I.r+14}"
                          text-anchor="middle" font-family="${i}" font-size="${a}"
                          fill="${I}" opacity="${B}" font-weight="600">${de}</text>
                    <text x="${e.I.cx}" y="${e.I.cy+e.I.r+14+a+2}"
                          text-anchor="middle" font-family="${i}" font-size="${a-1}"
                          fill="${I}" opacity="${N}">${_e}</text>
                    ...
                    ${this._showBattery?j`<g filter="url(#glowBattery)" class="clickable"
                       ...
                       @click=${()=>this._showMoreInfo("battery_soc")}>
                        ${this._illustrationBattery(e.B.cx,e.B.cy,e.B.r,L,O,U,H,h)}
                    </g>
                    ...
                    <text x="${e.G.cx}" y="${e.G.labelY}" text-anchor="middle"
                          font-family="${i}" font-size="${s}" font-weight="700"
                          fill="${G}" letter-spacing="0.5">${this._t("grid")}</text>
                    ...
                    ${me.length>0?W`
                        <foreignObject x="${t?8:10}" y="${e.statusY}" width="220" height="22">
                            <div xmlns="http://www.w3.org/1999/xhtml"
                                 style="font-family:'Segoe UI','Roboto',sans-serif;font-size:11px;color:#ef5350;opacity:0.75;white-space:nowrap">⚠ ${me.length} ${this._t("sensor_unavailable")}</div>
                        </foreignObject>
                    `:q}
        ...
        `)}_collectDevices(){const e=this._eid("controllable_devices_count"),t=e?this._hass?.states[e]:void 0;return t?.attributes?.devices?Object.entries(t.attributes.devices).filter(([,e])=>"ev_charger"!==e.device_type&&"battery"!==e.device_type).map(([e,t])=>{const i=t.power_entity?this._hass.states[t.power_entity]:null,s=i?parseFloat(i.state)||0:t.current_power||0;return{id:e,...t,power:s,name:this._localizedDeviceName(e,t)}}).sort((e,t)=>t.power-e.power).slice(0,3):[]}_localizedDeviceName(e,t){const i={heat_pump:"device_heat_pump",hot_water:"device_hot_water"},s={heat_pump:"Heat Pump",hot_water:"Hot Water"}[e];if(s&&(t.name||"").trim()===s){const t=this._t(i[e]);if(t)return t}return t.name||e}_renderDeviceChips(){const e=this._collectDevices();return e.length?W`
            ...
            <feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge>
                       ...
                       <line x1="-1.5" y1="6" x2="1.5" y2="6"/>`:j`<path d="M-2.5,-9 L-2.5,0 L-5,0 L0,9 L0,0 L2.5,0 L-2.5,-9Z"/>`}getCardSize(){return 7}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"sem-system-diagram-card",name:"SEM System Diagram",description:"Power flow visualization with inline SVG illustrations for each energy component"});const Pt=["/local/custom_components/solar_energy_management/dashboard/card/vendor/chart.umd.min.js","https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js"],At=["/local/custom_components/solar_energy_management/dashboard/card/vendor/chartjs-adapter-date-fns.bundle.min.js","https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3.0.0/dist/chartjs-adapter-date-fns.bundle.min.js"];function Tt(e,t,i){if(!e.length)return void i(new Error("all sources failed"));const s=document.createElement("script");s.src=e[0],s.onload=()=>t(),s.onerror=()=>Tt(e.slice(1),t,i),document.head.appendChild(s)}let Rt=null;const Lt=pe||{solar:"#ff9800",gridImport:"#488fc2",gridExport:"#8353d1",batteryOut:"#4db6ac",home:"#5BC8D8",ev:"#8DC892"},Ot={costs:{title:"energy_costs",y_label:"_currency_",stacked:!1,daily:[{suffix:"daily_costs",name:"Import",color:Lt.gridImport,type:"bar",negate:!0},{suffix:"daily_export_revenue",name:"export",color:Lt.gridExport,type:"bar"},{suffix:"daily_net_cost",name:"net",color:Lt.solar,type:"line",negate:!0}],monthly:[{suffix:"monthly_costs",name:"Import",color:Lt.gridImport,type:"bar",negate:!0},{suffix:"monthly_export_revenue",name:"export",color:Lt.gridExport,type:"bar"},{suffix:"monthly_net_cost",name:"net",color:Lt.solar,type:"line",negate:!0}]},savings:{title:"energy_savings",y_label:"_currency_",stacked:!0,daily:[{suffix:"daily_savings",name:"solar_savings",color:Lt.solar,type:"area"},{suffix:"daily_battery_savings",name:"battery_savings",color:Lt.batteryOut,type:"area"}],monthly:[{suffix:"monthly_savings",name:"solar_savings",color:Lt.solar,type:"area"},{suffix:"monthly_battery_savings",name:"battery_savings",color:Lt.batteryOut,type:"area"}]},energy:{title:"energy_balance",y_label:"kWh",stacked:!1,defaultPeriod:"7d",daily:[{suffix:"daily_solar_energy",name:"solar",color:Lt.solar,type:"bar"},{suffix:"daily_home_energy",name:"home",color:Lt.home,type:"bar"},{suffix:"daily_grid_import_energy",name:"grid_import",color:Lt.gridImport,type:"bar"},{suffix:"daily_grid_export_energy",name:"grid_export",color:Lt.gridExport,type:"bar"}],monthly:[{suffix:"monthly_solar_energy",name:"solar",color:Lt.solar,type:"bar"},{suffix:"monthly_home_energy",name:"home",color:Lt.home,type:"bar"},{suffix:"monthly_grid_import_energy",name:"grid_import",color:Lt.gridImport,type:"bar"},{suffix:"monthly_grid_export_energy",name:"grid_export",color:Lt.gridExport,type:"bar"}]},power:{title:"power_flow",y_label:"W",stacked:!1,hourly:[{suffix:"solar_power",name:"solar",color:Lt.solar,type:"area"},{suffix:"home_consumption_power",name:"home",color:Lt.home,type:"area"},{suffix:"grid_power",name:"grid",color:Lt.gridImport,type:"area"}]},forecast:{title:"forecast_vs_actual",y_label:"W",stacked:!1,hourly:[{suffix:"forecast_power_now_w",name:"forecast",color:Lt.solar,type:"area"},{suffix:"solar_power",name:"actual",color:Lt.batteryOut,type:"line"}]},battery:{title:"battery",y_label:"W",y2_label:"%",stacked:!1,hourly:[{suffix:"battery_power",name:"power",color:Lt.batteryOut,type:"area"},{suffix:"battery_soc",name:"soc",color:"#ff9800",type:"line",y_axis:1}]},ev:{title:"ev_charging",y_label:"W",stacked:!0,defaultPeriod:"today",y_min:0,y_suggested_max:2e3,hourly:[{suffix:"flow_solar_to_ev_power",name:"solar",color:Lt.solar,type:"area"},{suffix:"flow_battery_to_ev_power",name:"battery",color:Lt.batteryOut,type:"area"},{suffix:"flow_grid_to_ev_power",name:"grid",color:Lt.gridImport,type:"area"}],daily:[{suffix:"daily_ev_energy",name:"ev_energy",color:Lt.ev,type:"bar"}],monthly:[{suffix:"monthly_ev_energy",name:"ev_energy",color:Lt.ev,type:"bar"}]}};we("sem-chart-card",class extends Se{constructor(){super(),this._chart=null,this._period=null,this._fetchTimer=null,this._cachedChartTheme=null,this._boundPeriodHandler=e=>this._onPeriodChange(e.detail),this._prefix="sensor.sem_",this._preset=null,this._emptyMsg=""}setConfig(e){if(!e.preset&&!e.series)throw new Error("sem-chart-card requires either preset or series config");this._config=e,this._prefix=e.entity_prefix||"sensor.sem_",this._preset=e.preset?Ot[e.preset]:null,this.requestUpdate()}set hass(e){this._hass=e;const t=e?.language;if(t!==this._lang)return this._lang=t,void this.requestUpdate();this._period||this._setDefaultPeriod()}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),document.addEventListener("sem-period-change",this._boundPeriodHandler),this._rollInterval=setInterval(()=>this._rollRelativePeriod(),3e5),this._boundVisibility=()=>{document.hidden||this._rollRelativePeriod()},document.addEventListener("visibilitychange",this._boundVisibility)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("sem-period-change",this._boundPeriodHandler),this._boundVisibility&&document.removeEventListener("visibilitychange",this._boundVisibility),clearInterval(this._rollInterval),this._chart&&(this._chart.destroy(),this._chart=null),clearTimeout(this._fetchTimer)}_rollRelativePeriod(){if(!this._period||!this._hass)return;const e=this._config?.default_period||this._preset?.defaultPeriod,t="24h"===e?"24h":"7d"===e?"7d":"today"===e?"today":"week";this._period.key===t&&this._setDefaultPeriod()}firstUpdated(){this._period||this._setDefaultPeriod()}static get styles(){return[ke,a`
            :host { display: block; }
            .sem-chart-wrap {
                padding: 16px;
                min-height: 280px;
            ...
            <ha-card>
                <div class="card-content">
                    ...
                    <div id="device-list" class="device-list">
                        ${0===this.devices.length?W`<div class="empty">${this._t("no_devices_yet")}</div>`:Xt(this.devices,e=>e.id,(e,t)=>this._renderDevice(e,t+1))}
                    </div>
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s=this._switchOn("observer_mode"),r=this._hass?.states["switch.sem_observer_mode"],a=Number(r?.attributes?.observation_remaining_seconds),o=Number.isFinite(a),n=!0===r?.attributes?.ready_for_manual_activation,l=o?function(e){let t=Number(e);Number.isFinite(t)||(t=259200),t=Math.max(0,Math.ceil(t));const i=Math.floor(t/3600),s=Math.floor(t%3600/60),r=t%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}(a):null,c={surplus:e=>this._renderSurplusSection(e),battery:e=>this._renderBatterySection(e),hotwater:e=>this._renderHotWaterSection(e),heatpump:e=>this._renderHeatPumpSection(e),tariff:e=>this._renderTariffSection(e),peak:e=>this._renderPeakSection(e)};return W`
            <style>
                :host { display: block; contain: layout style paint; }
                .wrap {
                    padding: 16px;
                ...
                .observer-detail { color: var(--secondary-text-color, ${e.textSec}); font-size: 12px; font-weight: 500; }
                .observer-countdown {
                    flex: 0 0 auto;
                    min-width: 78px;
                    padding: 5px 8px;
                    ...
                    <span class="observer-copy">
                        ...
                        ${o?W`
                            <span class="observer-detail">
                                ${n?this._t("observer_ready_manual"):this._t("observer_time_remaining")}
                            </span>
                        `:q}
                    </span>
                    ${o?W`<span class="observer-countdown">${l}</span>`:q}
                </div>
                ${ii.map(t=>this._renderSection(t,c[t.id],e))}
            </div>
        `}getCardSize(){return 12}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-control-card",name:"SEM Control Card",description:"Consolidated control panel for Solar Energy Management",preview:!1});class ri extends ce{static get properties(){return{hass:{type:Object},entryId:{type:String,attribute:"entry-id"},optionKey:{type:String,attribute:"option-key"},chargerIndex:{type:Number,attribute:"charger-index"},chargerKey:{type:String,attribute:"charger-key"},domain:{type:String},includeDeviceClass:{type:String,attribute:"include-device-class"},label:{type:String},_saving:{state:!0},_error:{state:!0}}}constructor(){super(),this.entryId="",this.optionKey="",this.chargerIndex=-1,this.chargerKey="",this.domain="",this.includeDeviceClass="",this.label="",this._saving=!1,this._error=""}static get styles(){return a`
        ...
        `}_renderPicker(e,t,i,s,r,a){const o=this._saveStatus[e],n=ni.has(e),l=n&&Object.prototype.hasOwnProperty.call(this._pending,e),c=l?this._pending[e]:r[e]||"",d=t=>{n?(this._pending={...this._pending,[e]:t||""},this.requestUpdate()):this._saveOption(e,t,e)};return W`
            <div class="picker-cell">
                <div class="picker-row">
        ...
        `}_renderOptionToggle(e,t,i,s,r){const a=ni.has(e),o="opt:"+e;a||this._reg(o);const n=a&&Object.prototype.hasOwnProperty.call(this._pending,e),l=null!=i[e]?!!i[e]:!!r,c=n||!a&&this._isDirty(o),d=n?!!this._pending[e]:!a&&this._isDirty(o)?!!this._staged[o].value:l;return W`
        ...
        `}render(){if(!this._config)return q;const e=this._theme(),t=!1!==e.isDark,i=e.accent||"#42a5f5",s={overview:e=>this._renderOverview(e),sensor_sources:e=>this._renderSensorSources(e),ev_chargers:e=>this._renderEvChargers(e),battery_zones:e=>this._renderBatteryZones(e),tariff:e=>this._renderTariff(e),heat_pump:e=>this._renderHeatPump(e),hot_water:e=>this._renderHotWater(e),battery_scheduler:e=>this._renderBatteryScheduler(e),load_management:e=>this._renderLoadManagement(e),forecast:e=>this._renderForecast(e),pv_strings:e=>this._renderPvStrings(e),notifications:e=>this._renderNotifications(e),advanced:e=>this._renderAdvanced(e)};return W`
            ...
            <ha-card>
                <div class="wrap">
                    ...
                    ${ai.filter(e=>"pv_strings"!==e.id||this._pvStrings().length>=2).map(t=>this._renderSection(t,s[t.id],e))}
                </div>
            </ha-card>
        `}getCardSize(){return 12}static getStubConfig(){return{entity_prefix:"sensor.sem_"}}},{type:"custom:sem-config-card",name:"SEM Configuration Card",description:"In-dashboard SEM configuration surface (replaces the Settings → SEM → Configure flow for most users)",preview:!1});const li="sem-config-tab-introduced-v1";we("sem-onboarding-banner",class extends Se{static get watchedEntities(){return[]}static get properties(){return{...super.properties,_dismissed:{state:!0}}}constructor(){super(),this._dismissed=this._isDismissed()}setConfig(e){super.setConfig(e),this._configPath=e.config_tab_path||"/config"}_isDismissed(){try{return"1"===localStorage.getItem(li)}catch(e){return!1}}_dismiss(){try{localStorage.setItem(li,"1")}catch(e){}this._dismissed=!0}_openConfig(){const e=window.location.pathname.split("/").filter(Boolean);if(e.length>=2){const t="/"+e.slice(0,-1).join("/");window.history.pushState(null,"",`${t}/config`)}else window.history.pushState(null,"",this._configPath);window.dispatchEvent(new Event("location-changed",{composed:!0})),this._dismiss()}render(){if(this._dismissed)return q;if(!this._config)return q;const e=this._theme(),t="#8DC892";return W`
            <style>
                :host { display: block; }
                .banner {
                    display: flex; align-items: center; gap: 12px;
        ...
        `}getCardSize(){return 1}static getStubConfig(){return{}}},{type:"custom:sem-onboarding-banner",name:"SEM Onboarding Banner",description:"One-time welcome banner pointing existing users to the new Configuration tab",preview:!1});class ci extends Se{static get properties(){return{...super.properties,section:{type:String},label:{type:String},_open:{state:!0},_busy:{state:!0},_payload:{state:!0},_error:{state:!0},_copied:{state:!0}}}constructor(){super(),this.section="all",this.label="",this._open=!1,this._busy=!1,this._payload=null,this._error=null,this._copied=!1,this._copiedTimer=null}disconnectedCallback(){super.disconnectedCallback(),this._copiedTimer&&(clearTimeout(this._copiedTimer),this._copiedTimer=null)}static get watchedEntities(){return[]}async _click(){if(this._hass){this._open=!0,this._busy=!0,this._error=null,this._payload=null;try{const e=await this._hass.callService("solar_energy_management","diagnose",{section:this.section||"all"},void 0,void 0,!0);this._payload=e?.response||e}catch(e){this._error=e?.message||String(e),console.error("[sem-diagnose-button] failed",e)}finally{this._busy=!1}}}_close(){this._open=!1,this._copied=!1,this._payload=null,this._error=null}async _copy(){if(!this._payload)return;const e=JSON.stringify(this._payload,null,2),t=()=>{this._copied=!0,this._error=null,this._copiedTimer&&clearTimeout(this._copiedTimer),this._copiedTimer=setTimeout(()=>{this._copiedTimer=null,this._copied=!1},1500)};if(navigator?.clipboard?.writeText&&!1!==window.isSecureContext)try{return await navigator.clipboard.writeText(e),void t()}catch(e){console.warn("[sem-diagnose-button] modern clipboard refused, falling back to execCommand",e)}try{const i=document.createElement("textarea");i.value=e,i.setAttribute("readonly",""),i.style.position="fixed",i.style.top="0",i.style.left="0",i.style.width="1px",i.style.height="1px",i.style.opacity="0",document.body.appendChild(i),i.focus(),i.select();const s=document.execCommand("copy");if(document.body.removeChild(i),s)return void t();console.error('[sem-diagnose-button] execCommand("copy") returned false')}catch(e){console.error("[sem-diagnose-button] legacy clipboard fallback threw",e)}this._error=this._t("config_diagnose_clipboard_failed")}render(){const e=this._theme(),t=e.accent||"#5BC8D8",i=this.label||this._t("config_diagnose");return W`
            ...
            `:q}
        `}}customElements.get("sem-diagnose-button")||customElements.define("sem-diagnose-button",ci),console.info("%c SEM Cards %c Lit Bundle ","color: #4db6ac; font-weight: bold; background: #1e232d; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #ff9800; background: #1e232d; padding: 2px 6px; border-radius: 0 4px 4px 0;");
