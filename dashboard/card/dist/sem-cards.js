            ...
            <ha-card>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${t.vb}"
                    ...
                    <text x="${t.B.cx}" y="${t.B.labelY+1*r}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${r}"
                          font-weight="800" fill="${T}">${it}</text>
