                    ...
                    <div class="session-section">
                        <div class="sess-header">
                            <ha-icon icon="mdi:battery-sync"
                                style="--mdc-icon-size:14px;color:${P?H:e.textSec}">
                            </ha-icon>
                            <span class="sess-title" style="color:${P?H:e.textSec}">
            ...
            <ha-card>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${e.vb}"
                    ...
                    <g class="flow-group" style="opacity:${Be?1:0}">
                        ${this._renderFlow(Pe,Ne,fe(n||l),e.paths.grid,3)}
                    </g>
