                    ...
                    <div class="session-section">
                        <div class="sess-header">
                            <ha-icon icon="mdi:battery-sync"
                                style="--mdc-icon-size:14px;color:${M?P:t.textSec}">
                            </ha-icon>
                            <span class="sess-title" style="color:${M?P:t.textSec}">
                        ...
                        <div class="sess-grid">
                            ...
                            <div>
                                ...
                                <div class="sess-item-value">
                                    ${D?`${this._t("solar")}: ${this._fmt(N,0)}%`:""}
                                </div>
                            </div>
                            <div>
                                <div class="sess-item-label">${this._t("cost")}</div>
                                <div class="sess-item-value">
                                    ${D?`${this._fmt(A,2)} ${f}`:`${this._t("saved")} ${this._fmt(R,2)} ${f}`}
                                </div>
                            </div>
                        </div>
                        `:W``}
            ...
            <ha-card>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="${t.vb}"
                    ...
                    <text x="${t.E.cx}" y="${t.E.labelY+1*r+s+a+2}" class="clickable"
                          ...
                          text-anchor="middle" font-family="${i}" font-size="${a+1}"
                          fill="#8DC892" opacity="0.6" font-weight="600">${q}</text>
